...
void THStack_plot_E_sideband() {
    ...
    const char* Sideband_MC_CHG_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_EL/CHG_analysis/validation_v004/final_output";
    const char* Sideband_MC_MIX_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_EL/MIX_analysis/validation_v004/final_output";
    const char* Sideband_MC_UUBAR_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_EL/UUBAR_analysis/validation_v004/final_output";
    const char* Sideband_MC_DDBAR_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_EL/DDBAR_analysis/validation_v004/final_output";
    const char* Sideband_MC_SSBAR_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_EL/SSBAR_analysis/validation_v004/final_output";
    const char* Sideband_MC_CHARM_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_EL/CHARM_analysis/validation_v004/final_output";

    const char* Sideband_data_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_data_EL/SIGNAL_analysis/validation_v004/final_output";
    ...
    LetsFillMC_ESide(Sideband_MC_CHG_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "CHG");
    LetsFillMC_ESide(Sideband_MC_MIX_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "MIX");
    LetsFillMC_ESide(Sideband_MC_UUBAR_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "UUBAR");
    LetsFillMC_ESide(Sideband_MC_DDBAR_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "DDBAR");
    LetsFillMC_ESide(Sideband_MC_SSBAR_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "SSBAR");
    LetsFillMC_ESide(Sideband_MC_CHARM_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "CHARM");
