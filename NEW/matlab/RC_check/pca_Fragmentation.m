...
% Fragmentation
FragmentationfileID = fopen(fullfile(base_dir, 'Fragmentation_toys.txt'),'r');
...
FragmentationfileID_w = fopen(fullfile(base_dir, 'Fragmentation_cov_all.txt'),'w');
...
FragmentationfileID_w = fopen(fullfile(base_dir, 'Fragmentation_cov_all_truncated.txt'),'w');
for i = 1:N_total_bins
...
FragmentationfileID_w = fopen(fullfile(base_dir, 'Fragmentation_corr_all.txt'),'w');
for i = 1:N_total_bins
    for j = 1:N_total_bins
...
FragmentationfileID_w = fopen(fullfile(base_dir, 'Fragmentation_selected.txt'),'w');
for j = 1:N_selected_vectors
...
FragmentationfileID_w = fopen(fullfile(base_dir, 'Fragmentation_cov_partial.txt'),'w');
for i = 1:N_total_bins
    for j = 1:N_total_bins
...
FragmentationfileID_w = fopen(fullfile(base_dir, 'Fragmentation_corr_partial.txt'),'w');
for i = 1:N_total_bins
    for j = 1:N_total_bins
...
FragmentationfileID_w = fopen(fullfile(base_dir, 'Fragmentation_cov_remain_truncated.txt'),'w');
for i = 1:N_total_bins
