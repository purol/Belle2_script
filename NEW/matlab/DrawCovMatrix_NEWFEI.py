...
# pi0
file_pi0_cov_all = "NEWFEICAL_corr_all.txt"
file_pi0_cov_partial = "NEWFEICAL_corr_partial.txt"
...
labels = ["Signal_1", "Signal_2", "Signal_3"]
...
#plt.show()
plt.savefig('NEWFEICAL_corr_all.png')
...
#plt.show()
plt.savefig('NEWFEICAL_corr_partial.png')
