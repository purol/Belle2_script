...
# define CAL_qq_K_FBDT_side 1.0308
# define CAL_qq_Kstar_FBDT_side 1.0794
# define CAL_qq_Xs_FBDT_side 0.8430

# define CAL_qq_K_signal 1.2123
# define CAL_qq_Kstar_signal 0.8785
# define CAL_qq_Xs_signal 0.7464

/* ====================================== */

TH1D* Nevt_MC_FBDT_side = new TH1D("Nevt_MC_FBDT_side", "Nevt_MC_FBDT_side", 3, 0, 3.0);
TH1D* Nevt_MC_signal = new TH1D("Nevt_MC_signal", "Nevt_MC_signal", 3, 0, 3.0);
TH1D* Nevt_data_FBDT_side = new TH1D("Nevt_data_FBDT_side", "Nevt_data_FBDT_side", 3, 0, 3.0);
TH1D* Nevt_data_signal = new TH1D("Nevt_data_signal", "Nevt_data_signal", 3, 0, 3.0);

TH1D* Correction_factor = new TH1D("Correction_factor", "Correction_factor", 3, 0, 3.0);

void GetNominalNevt(const char* dirname, const char* included_string, const char* type, const char* sample, TH1D* hist, double weight_var = 1.0, std::string CorrectionType = "otherwise", bool tight = false) { // get nominal PDF with appropriate correction
    /*
...
void GetDataNevt(const char* dirname, const char* included_string, TH1D* hist, bool tight = false) { // get nominal PDF with appropriate correction
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        for (unsigned int j = 0; j < tree_upsilon->GetEntries(); j++) { // Fill
            ...
            else if ((Bsig_M > 1.0) && (Bsig_M < 6.0)) hist->Fill(2.5, 1.0);
...
int main(int argc, char* argv[]) {
    ...
    const char* dirname_data_signal = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD_LS_data/SIGNAL_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut";

    const char* dirname_CHG_signal = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD/CHG_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut/Merge";
    const char* dirname_MIX_signal = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD/MIX_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut/Merge";
    const char* dirname_UUBAR_signal = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD/UUBAR_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut/Merge";
    const char* dirname_DDBAR_signal = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD/DDBAR_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut/Merge";
    const char* dirname_SSBAR_signal = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD/SSBAR_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut/Merge";
    const char* dirname_CHARM_signal = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD/CHARM_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut/Merge";

    const char* dirname_data_FBDT_side = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD_LS_data_FBDTside/SIGNAL_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut";

    const char* dirname_CHG_FBDT_side = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD_LS_MC_FBDTside/CHG_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut";
    const char* dirname_MIX_FBDT_side = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD_LS_MC_FBDTside/MIX_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut";
    const char* dirname_UUBAR_FBDT_side = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD_LS_MC_FBDTside/UUBAR_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut";
    const char* dirname_DDBAR_FBDT_side = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD_LS_MC_FBDTside/DDBAR_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut";
    const char* dirname_SSBAR_FBDT_side = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD_LS_MC_FBDTside/SSBAR_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut";
    const char* dirname_CHARM_FBDT_side = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD_LS_MC_FBDTside/CHARM_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut";

    GetDataNevt(dirname_data_signal, "root", Nevt_data_signal);

    GetNominalNevt(dirname_CHG_signal, "root", "Bplus", "CHG", Nevt_MC_signal, ObtainWeight("CHG", MCTYPE, "validation", "CHG"), "otherwise");
    GetNominalNevt(dirname_MIX_signal, "root", "Bzero", "MIX", Nevt_MC_signal, ObtainWeight("MIX", MCTYPE, "validation", "MIX"), "otherwise");
    GetNominalNevt(dirname_UUBAR_signal, "root", "Continuum", "UUBAR", Nevt_MC_signal, CAL_qq_K_signal * ObtainWeight("UUBAR", MCTYPE, "validation", "UUBAR"), "otherwise");
    GetNominalNevt(dirname_DDBAR_signal, "root", "Continuum", "DDBAR", Nevt_MC_signal, CAL_qq_K_signal * ObtainWeight("DDBAR", MCTYPE, "validation", "DDBAR"), "otherwise");
    GetNominalNevt(dirname_SSBAR_signal, "root", "Continuum", "SSBAR", Nevt_MC_signal, CAL_qq_K_signal * ObtainWeight("SSBAR", MCTYPE, "validation", "SSBAR"), "otherwise");
    GetNominalNevt(dirname_CHARM_signal, "root", "Continuum", "CHARM", Nevt_MC_signal, CAL_qq_K_signal * ObtainWeight("CHARM", MCTYPE, "validation", "CHARM"), "otherwise");

    GetDataNevt(dirname_data_FBDT_side, "root", Nevt_data_FBDT_side);

    GetNominalNevt(dirname_CHG_FBDT_side, "root", "Bplus", "CHG", Nevt_MC_FBDT_side, ObtainWeight("CHG", MCTYPE, "validation", "CHG"), "otherwise");
    GetNominalNevt(dirname_MIX_FBDT_side, "root", "Bzero", "MIX", Nevt_MC_FBDT_side, ObtainWeight("MIX", MCTYPE, "validation", "MIX"), "otherwise");
    GetNominalNevt(dirname_UUBAR_FBDT_side, "root", "Continuum", "UUBAR", Nevt_MC_FBDT_side, CAL_qq_K_FBDT_side * ObtainWeight("UUBAR", MCTYPE, "validation", "UUBAR"), "otherwise");
    GetNominalNevt(dirname_DDBAR_FBDT_side, "root", "Continuum", "DDBAR", Nevt_MC_FBDT_side, CAL_qq_K_FBDT_side * ObtainWeight("DDBAR", MCTYPE, "validation", "DDBAR"), "otherwise");
    GetNominalNevt(dirname_SSBAR_FBDT_side, "root", "Continuum", "SSBAR", Nevt_MC_FBDT_side, CAL_qq_K_FBDT_side * ObtainWeight("SSBAR", MCTYPE, "validation", "SSBAR"), "otherwise");
    GetNominalNevt(dirname_CHARM_FBDT_side, "root", "Continuum", "CHARM", Nevt_MC_FBDT_side, CAL_qq_K_FBDT_side * ObtainWeight("CHARM", MCTYPE, "validation", "CHARM"), "otherwise");

    Correction_factor->Divide(Nevt_data_FBDT_side, Nevt_MC_FBDT_side);

    printf("Nevt data signal region, K: %lf +- %lf\n", Nevt_data_signal->GetBinContent(1), Nevt_data_signal->GetBinError(1));
    printf("Nevt data signal region, Kstar: %lf +- %lf\n", Nevt_data_signal->GetBinContent(2), Nevt_data_signal->GetBinError(2));
    printf("Nevt data signal region, Xs: %lf +- %lf\n", Nevt_data_signal->GetBinContent(3), Nevt_data_signal->GetBinError(3));

    printf("Nevt MC signal region, K: %lf +- %lf\n", Nevt_MC_signal->GetBinContent(1), Nevt_MC_signal->GetBinError(1));
    printf("Nevt MC signal region, Kstar: %lf +- %lf\n", Nevt_MC_signal->GetBinContent(2), Nevt_MC_signal->GetBinError(2));
    printf("Nevt MC signal region, Xs: %lf +- %lf\n", Nevt_MC_signal->GetBinContent(3), Nevt_MC_signal->GetBinError(3));

    printf("Nevt data FBDT sideband region, K: %lf +- %lf\n", Nevt_data_FBDT_side->GetBinContent(1), Nevt_data_FBDT_side->GetBinError(1));
    printf("Nevt data FBDT sideband region, Kstar: %lf +- %lf\n", Nevt_data_FBDT_side->GetBinContent(2), Nevt_data_FBDT_side->GetBinError(2));
    printf("Nevt data FBDT sideband region, Xs: %lf +- %lf\n", Nevt_data_FBDT_side->GetBinContent(3), Nevt_data_FBDT_side->GetBinError(3));

    printf("Nevt MC FBDT sideband region, K: %lf +- %lf\n", Nevt_MC_FBDT_side->GetBinContent(1), Nevt_MC_FBDT_side->GetBinError(1));
    printf("Nevt MC FBDT sideband region, Kstar: %lf +- %lf\n", Nevt_MC_FBDT_side->GetBinContent(2), Nevt_MC_FBDT_side->GetBinError(2));
    printf("Nevt MC FBDT sideband region, Xs: %lf +- %lf\n", Nevt_MC_FBDT_side->GetBinContent(3), Nevt_MC_FBDT_side->GetBinError(3));

    printf("Correction factor, K: %lf +- %lf\n", Correction_factor->GetBinContent(1), Correction_factor->GetBinError(1));
    printf("Correction factor, Kstar: %lf +- %lf\n", Correction_factor->GetBinContent(2), Correction_factor->GetBinError(2));
    printf("Correction factor, Xs: %lf +- %lf\n", Correction_factor->GetBinContent(3), Correction_factor->GetBinError(3));
