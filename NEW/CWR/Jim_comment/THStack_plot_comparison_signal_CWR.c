...
void THStack_plot_comparison_signal() {
    ...
    LetsFill_ri(el7_signal_validation_dirname, variable_names, branch_names, el7_values, &MC_numbering, &el7_weights, "SIGNAL", "el7", "validation", CAL_el7, 1.0, 1.0, 1.0, "B2Knunu");
    LetsFill_ri(el7_signal_validation_dirname, variable_names, branch_names, el7_values, &MC_numbering, &el7_weights, "SIGNAL", "el7", "validation", CAL_el7, 1.0, 1.0, 1.0, "B2Kstarnunu");
    LetsFill_ri(el7_signal_validation_dirname, variable_names, branch_names, el7_values, &MC_numbering, &el7_weights, "SIGNAL", "el7", "validation", CAL_el7, 1.0, 1.0, 1.0, "B2Xsnunu");
    LetsFill_ri(el7_signal_validation_dirname, variable_names, branch_names, el7_values, &MC_numbering, &el7_weights, "SIGNAL", "el7", "validation", CAL_el7, 1.0, 1.0, 1.0, "B02K0nunu");
    LetsFill_ri(el7_signal_validation_dirname, variable_names, branch_names, el7_values, &MC_numbering, &el7_weights, "SIGNAL", "el7", "validation", CAL_el7, 1.0, 1.0, 1.0, "B02Kstar0nunu");
    LetsFill_ri(el7_signal_validation_dirname, variable_names, branch_names, el7_values, &MC_numbering, &el7_weights, "SIGNAL", "el7", "validation", CAL_el7, 1.0, 1.0, 1.0, "B02Xsnunu");
    LetsFill_ri(el9_signal_validation_dirname, variable_names, branch_names, el9_values, &MC_numbering, &el9_weights, "SIGNAL", "el9", "validation", CAL_el9, 1.0, 1.0, 1.0, "B2Knunu");
    LetsFill_ri(el9_signal_validation_dirname, variable_names, branch_names, el9_values, &MC_numbering, &el9_weights, "SIGNAL", "el9", "validation", CAL_el9, 1.0, 1.0, 1.0, "B2Kstarnunu");
    LetsFill_ri(el9_signal_validation_dirname, variable_names, branch_names, el9_values, &MC_numbering, &el9_weights, "SIGNAL", "el9", "validation", CAL_el9, 1.0, 1.0, 1.0, "B2Xsnunu");
    LetsFill_ri(el9_signal_validation_dirname, variable_names, branch_names, el9_values, &MC_numbering, &el9_weights, "SIGNAL", "el9", "validation", CAL_el9, 1.0, 1.0, 1.0, "B02K0nunu");
    LetsFill_ri(el9_signal_validation_dirname, variable_names, branch_names, el9_values, &MC_numbering, &el9_weights, "SIGNAL", "el9", "validation", CAL_el9, 1.0, 1.0, 1.0, "B02Kstar0nunu");
    LetsFill_ri(el9_signal_validation_dirname, variable_names, branch_names, el9_values, &MC_numbering, &el9_weights, "SIGNAL", "el9", "validation", CAL_el9, 1.0, 1.0, 1.0, "B02Xsnunu");
    ...
    for (int k = 0; k < (int)variable_names.size(); k++) { // malloc TH1D
        ...
        temp_v.insert(temp_v.end(), el7_values[k].begin(), el7_values[k].end());
        temp_v.insert(temp_v.end(), el9_values[k].begin(), el9_values[k].end());
        ...
        el7_hist[k] = new TH1D("el7 signal", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        el9_hist[k] = new TH1D("el9 signal", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
    ...
    for (int k = 0; k < (int)variable_names.size(); k++) { // draw
        ...
        c_temp->SaveAs((variable_names.at(k) + "_el7_vs_el9_signal.png").c_str());
