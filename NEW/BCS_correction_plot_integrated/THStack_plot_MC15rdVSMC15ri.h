...
Corrector_Multiplicity corrector_Multiplicity_MC15rd_old("./multiplicity_weight_MC15rd_old.txt");
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        for (unsigned int j = 0; j < tree_upsilon->GetEntries(); j++) { // Fill
            ...
            if (SampleName == "CHG" && MCTYPE == "MC15ri") {
                ...
                if (IsItOld == false) numberings->push_back(0 + IndexShift);
                else numberings->push_back(0);
                FEI_calibration_factor = corrector_FEI.GetFEICalFactor(Upsilon_ID, Btag_ID, MCTYPE);
                weight_ri = ObtainWeight(SampleName.c_str(), MCTYPE.c_str(), sample_type.c_str(), names.at(i));
            }
            else if (SampleName == "MIX" && MCTYPE == "MC15rd") {
                if (IsItOld == false) numberings->push_back(1 + IndexShift);
                else numberings->push_back(1);
                FEI_calibration_factor = corrector_FEI.GetFEICalFactor(Upsilon_ID, Btag_ID, MCTYPE);
                weight_ri = ObtainWeight(SampleName.c_str(), MCTYPE.c_str(), sample_type.c_str(), names.at(i));
            }
            else if (SampleName == "UUBAR" && MCTYPE == "MC15rd") {
                if (IsItOld == false) numberings->push_back(2 + IndexShift);
                else numberings->push_back(2);
                if ((Bsig_M > 0.0) && (Bsig_M < 0.6)) FEI_calibration_factor = CAL_qq_K;
                else if ((Bsig_M > 0.6) && (Bsig_M < 1.0)) FEI_calibration_factor = CAL_qq_Kstar;
                else if ((Bsig_M > 1.0) && (Bsig_M < 2.0)) FEI_calibration_factor = CAL_qq_Xs;
                weight_ri = ObtainWeight(SampleName.c_str(), MCTYPE.c_str(), sample_type.c_str(), names.at(i));
                ...
                if (IsItOld == false) numberings->push_back(3 + IndexShift);
                else numberings->push_back(3);
                if ((Bsig_M > 0.0) && (Bsig_M < 0.6)) FEI_calibration_factor = CAL_qq_K;
                else if ((Bsig_M > 0.6) && (Bsig_M < 1.0)) FEI_calibration_factor = CAL_qq_Kstar;
                else if ((Bsig_M > 1.0) && (Bsig_M < 2.0)) FEI_calibration_factor = CAL_qq_Xs;
                weight_ri = ObtainWeight(SampleName.c_str(), MCTYPE.c_str(), sample_type.c_str(), names.at(i));
                ...
                if (IsItOld == false) numberings->push_back(4 + IndexShift);
                else numberings->push_back(4);
                if ((Bsig_M > 0.0) && (Bsig_M < 0.6)) FEI_calibration_factor = CAL_qq_K;
                else if ((Bsig_M > 0.6) && (Bsig_M < 1.0)) FEI_calibration_factor = CAL_qq_Kstar;
                else if ((Bsig_M > 1.0) && (Bsig_M < 2.0)) FEI_calibration_factor = CAL_qq_Xs;
                weight_ri = ObtainWeight(SampleName.c_str(), MCTYPE.c_str(), sample_type.c_str(), names.at(i));
                ...
                if (IsItOld == false) numberings->push_back(5 + IndexShift);
                else numberings->push_back(5);
                if ((Bsig_M > 0.0) && (Bsig_M < 0.6)) FEI_calibration_factor = CAL_qq_K;
                else if ((Bsig_M > 0.6) && (Bsig_M < 1.0)) FEI_calibration_factor = CAL_qq_Kstar;
                else if ((Bsig_M > 1.0) && (Bsig_M < 2.0)) FEI_calibration_factor = CAL_qq_Xs;
                weight_ri = ObtainWeight(SampleName.c_str(), MCTYPE.c_str(), sample_type.c_str(), names.at(i));
            ...
            else if (MCTYPE == "MC15rd") {
                if (IsItOld == false) Correction_multiplicity = corrector_Multiplicity_MC15rd.GetCorrectionFactor(Ngamma_v200);
                else Correction_multiplicity = corrector_Multiplicity_MC15rd_old.GetCorrectionFactor(Ngamma_v200);
            }
