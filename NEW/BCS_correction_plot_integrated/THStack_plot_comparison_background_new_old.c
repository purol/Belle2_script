...
void THStack_plot_comparison_background_new_old() {

    const char* old_CHG_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/CHG_analysis/validation_v010/final_output_root_after_MVA_Application/";
    const char* old_MIX_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/MIX_analysis/validation_v010/final_output_root_after_MVA_Application/";
    const char* old_UUBAR_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/UUBAR_analysis/validation_v010/final_output_root_after_MVA_Application/";
    const char* old_DDBAR_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/DDBAR_analysis/validation_v010/final_output_root_after_MVA_Application/";
    const char* old_SSBAR_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/SSBAR_analysis/validation_v010/final_output_root_after_MVA_Application/";
    const char* old_CHARM_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/CHARM_analysis/validation_v010/final_output_root_after_MVA_Application/";

    const char* new_CHG_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/CHG_analysis/validation_v009/final_output_root_after_MVA_Application/";
    const char* new_MIX_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/MIX_analysis/validation_v009/final_output_root_after_MVA_Application/";
    const char* new_UUBAR_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/UUBAR_analysis/validation_v009/final_output_root_after_MVA_Application/";
    const char* new_DDBAR_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/DDBAR_analysis/validation_v009/final_output_root_after_MVA_Application/";
    const char* new_SSBAR_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/SSBAR_analysis/validation_v009/final_output_root_after_MVA_Application/";
    const char* new_CHARM_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/CHARM_analysis/validation_v009/final_output_root_after_MVA_Application/";
    ...
    std::vector<double>* charged_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* mixed_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* uubar_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* ddbar_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* ssbar_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* ccbar_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* taupair_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* mumu_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* gg_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* ee_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* eeee_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* eemumu_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* llXX_MC15rd_old_values = new std::vector<double>[Nvar_num];
    std::vector<double>* hhISR_MC15rd_old_values = new std::vector<double>[Nvar_num];
    ...
    std::vector<double> charged_MC15rd_old_weights;
    std::vector<double> mixed_MC15rd_old_weights;
    std::vector<double> uubar_MC15rd_old_weights;
    std::vector<double> ddbar_MC15rd_old_weights;
    std::vector<double> ssbar_MC15rd_old_weights;
    std::vector<double> ccbar_MC15rd_old_weights;
    std::vector<double> taupair_MC15rd_old_weights;
    std::vector<double> mumu_MC15rd_old_weights;
    std::vector<double> gg_MC15rd_old_weights;
    std::vector<double> ee_MC15rd_old_weights;
    std::vector<double> eeee_MC15rd_old_weights;
    std::vector<double> eemumu_MC15rd_old_weights;
    std::vector<double> llXX_MC15rd_old_weights;
    std::vector<double> hhISR_MC15rd_old_weights;
    ...
    LetsFill_ri(old_CHG_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "CHG", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", true);
    LetsFill_ri(old_MIX_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "MIX", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", true);
    LetsFill_ri(old_UUBAR_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "UUBAR", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", true);
    LetsFill_ri(old_DDBAR_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "DDBAR", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", true);
    LetsFill_ri(old_SSBAR_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "SSBAR", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", true);
    LetsFill_ri(old_CHARM_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "CHARM", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", true);
    LetsFill_ri(new_CHG_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "CHG", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", false);
    LetsFill_ri(new_MIX_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "MIX", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", false);
    LetsFill_ri(new_UUBAR_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "UUBAR", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", false);
    LetsFill_ri(new_DDBAR_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "DDBAR", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", false);
    LetsFill_ri(new_SSBAR_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "SSBAR", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", false);
    LetsFill_ri(new_CHARM_validation_dirname, variable_names, branch_names, MC_values, &MC_numbering, &weights, "CHARM", "MC15rd", "validation", CAL_MC15rd, 1.0, 1.0, 1.0, "root", false);

    // sort variables
    for (int k = 0; k < (int)MC_numbering.size(); k++) {
        if (MC_numbering.at(k) == 0) {
            for (int l = 0; l < (int)variable_names.size(); l++) charged_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            charged_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 1) {
            for (int l = 0; l < (int)variable_names.size(); l++) mixed_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            mixed_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 2) {
            for (int l = 0; l < (int)variable_names.size(); l++) uubar_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            uubar_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 3) {
            for (int l = 0; l < (int)variable_names.size(); l++) ddbar_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            ddbar_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 4) {
            for (int l = 0; l < (int)variable_names.size(); l++) ssbar_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            ssbar_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 5) {
            for (int l = 0; l < (int)variable_names.size(); l++) ccbar_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            ccbar_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 6) {
            for (int l = 0; l < (int)variable_names.size(); l++) taupair_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            taupair_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 7) {
            for (int l = 0; l < (int)variable_names.size(); l++) mumu_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            mumu_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 8) {
            for (int l = 0; l < (int)variable_names.size(); l++) gg_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            gg_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 9) {
            for (int l = 0; l < (int)variable_names.size(); l++) ee_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            ee_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 10) {
            for (int l = 0; l < (int)variable_names.size(); l++) eeee_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            eeee_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 11) {
            for (int l = 0; l < (int)variable_names.size(); l++) eemumu_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            eemumu_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 12) {
            for (int l = 0; l < (int)variable_names.size(); l++) llXX_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            llXX_MC15rd_old_weights.push_back(weights.at(k));
        }
        else if (MC_numbering.at(k) == 13) {
            for (int l = 0; l < (int)variable_names.size(); l++) hhISR_MC15rd_old_values[l].push_back(MC_values[l].at(k));
            hhISR_MC15rd_old_weights.push_back(weights.at(k));
        }
        ...
        // for MC15rd_old vs MC15rd
        if (MC_numbering.at(k) < IndexShift) { // MC15rd_old
            for (int l = 0; l < (int)variable_names.size(); l++) MC15rd_old_values[l].push_back(MC_values[l].at(k));
            MC15rd_old_weights.push_back(weights.at(k));
        }
        else { // MC15rd
    ...
    TH1D** charged_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** mixed_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** uubar_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** ddbar_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** ssbar_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** ccbar_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** taupair_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** mumu_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** gg_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** ee_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** eeee_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** eemumu_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** llXX_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    TH1D** hhISR_MC15rd_old_hist = (TH1D**)malloc(sizeof(TH1D*) * Nvar_num);
    ...
    for (int k = 0; k < (int)variable_names.size(); k++) { // malloc TH1D
        ...
        temp_v.insert(temp_v.end(), charged_MC15rd_old_values[k].begin(), charged_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), mixed_MC15rd_old_values[k].begin(), mixed_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), uubar_MC15rd_old_values[k].begin(), uubar_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), ddbar_MC15rd_old_values[k].begin(), ddbar_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), ssbar_MC15rd_old_values[k].begin(), ssbar_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), ccbar_MC15rd_old_values[k].begin(), ccbar_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), taupair_MC15rd_old_values[k].begin(), taupair_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), mumu_MC15rd_old_values[k].begin(), mumu_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), gg_MC15rd_old_values[k].begin(), gg_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), ee_MC15rd_old_values[k].begin(), ee_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), eeee_MC15rd_old_values[k].begin(), eeee_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), eemumu_MC15rd_old_values[k].begin(), eemumu_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), llXX_MC15rd_old_values[k].begin(), llXX_MC15rd_old_values[k].end());
        temp_v.insert(temp_v.end(), hhISR_MC15rd_old_values[k].begin(), hhISR_MC15rd_old_values[k].end());
        ...
        charged_MC15rd_old_hist[k] = new TH1D("charged MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        mixed_MC15rd_old_hist[k] = new TH1D("mixed MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        uubar_MC15rd_old_hist[k] = new TH1D("u#bar{u} MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        ddbar_MC15rd_old_hist[k] = new TH1D("d#bar{d} MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        ssbar_MC15rd_old_hist[k] = new TH1D("s#bar{s} MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        ccbar_MC15rd_old_hist[k] = new TH1D("c#bar{c} MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        taupair_MC15rd_old_hist[k] = new TH1D("#tau#bar{#tau} MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        mumu_MC15rd_old_hist[k] = new TH1D("#mu#bar{#mu} MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        gg_MC15rd_old_hist[k] = new TH1D("gg MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        ee_MC15rd_old_hist[k] = new TH1D("e#bar{e} MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        eeee_MC15rd_old_hist[k] = new TH1D("ee#bar{e}#bar{e} MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        eemumu_MC15rd_old_hist[k] = new TH1D("e#bar{e}#mu#bar{#mu} MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        llXX_MC15rd_old_hist[k] = new TH1D("\ell#bar{\ell}XX MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
        hhISR_MC15rd_old_hist[k] = new TH1D("hhISR MC15rd_old", (";" + variable_names.at(k) + ";number of candidates").c_str(), bins, min, max);
    ...
    for (int i = 0; i < (int)charged_MC15rd_old_values[index].size(); i++) charged_MC15rd_old_values[index].at(i) = log10l(charged_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)mixed_MC15rd_old_values[index].size(); i++) mixed_MC15rd_old_values[index].at(i) = log10l(mixed_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)uubar_MC15rd_old_values[index].size(); i++) uubar_MC15rd_old_values[index].at(i) = log10l(uubar_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)ddbar_MC15rd_old_values[index].size(); i++) ddbar_MC15rd_old_values[index].at(i) = log10l(ddbar_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)ssbar_MC15rd_old_values[index].size(); i++) ssbar_MC15rd_old_values[index].at(i) = log10l(ssbar_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)ccbar_MC15rd_old_values[index].size(); i++) ccbar_MC15rd_old_values[index].at(i) = log10l(ccbar_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)taupair_MC15rd_old_values[index].size(); i++) taupair_MC15rd_old_values[index].at(i) = log10l(taupair_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)mumu_MC15rd_old_values[index].size(); i++) mumu_MC15rd_old_values[index].at(i) = log10l(mumu_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)gg_MC15rd_old_values[index].size(); i++) gg_MC15rd_old_values[index].at(i) = log10l(gg_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)ee_MC15rd_old_values[index].size(); i++) ee_MC15rd_old_values[index].at(i) = log10l(ee_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)eeee_MC15rd_old_values[index].size(); i++) eeee_MC15rd_old_values[index].at(i) = log10l(eeee_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)eemumu_MC15rd_old_values[index].size(); i++) eemumu_MC15rd_old_values[index].at(i) = log10l(eemumu_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)llXX_MC15rd_old_values[index].size(); i++) llXX_MC15rd_old_values[index].at(i) = log10l(llXX_MC15rd_old_values[index].at(i));
    for (int i = 0; i < (int)hhISR_MC15rd_old_values[index].size(); i++) hhISR_MC15rd_old_values[index].at(i) = log10l(hhISR_MC15rd_old_values[index].at(i));
    ...
    for (int k = 0; k < (int)variable_names.size(); k++) { // fill
        for (int i = 0; i < (int)charged_MC15rd_old_values[k].size(); i++) charged_MC15rd_old_hist[k]->Fill(charged_MC15rd_old_values[k].at(i), charged_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)mixed_MC15rd_old_values[k].size(); i++) mixed_MC15rd_old_hist[k]->Fill(mixed_MC15rd_old_values[k].at(i), mixed_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)uubar_MC15rd_old_values[k].size(); i++) uubar_MC15rd_old_hist[k]->Fill(uubar_MC15rd_old_values[k].at(i), uubar_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)ddbar_MC15rd_old_values[k].size(); i++) ddbar_MC15rd_old_hist[k]->Fill(ddbar_MC15rd_old_values[k].at(i), ddbar_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)ssbar_MC15rd_old_values[k].size(); i++) ssbar_MC15rd_old_hist[k]->Fill(ssbar_MC15rd_old_values[k].at(i), ssbar_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)ccbar_MC15rd_old_values[k].size(); i++) ccbar_MC15rd_old_hist[k]->Fill(ccbar_MC15rd_old_values[k].at(i), ccbar_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)taupair_MC15rd_old_values[k].size(); i++) taupair_MC15rd_old_hist[k]->Fill(taupair_MC15rd_old_values[k].at(i), taupair_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)mumu_MC15rd_old_values[k].size(); i++) mumu_MC15rd_old_hist[k]->Fill(mumu_MC15rd_old_values[k].at(i), mumu_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)gg_MC15rd_old_values[k].size(); i++) gg_MC15rd_old_hist[k]->Fill(gg_MC15rd_old_values[k].at(i), gg_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)ee_MC15rd_old_values[k].size(); i++) ee_MC15rd_old_hist[k]->Fill(ee_MC15rd_old_values[k].at(i), ee_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)eeee_MC15rd_old_values[k].size(); i++) eeee_MC15rd_old_hist[k]->Fill(eeee_MC15rd_old_values[k].at(i), eeee_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)eemumu_MC15rd_old_values[k].size(); i++) eemumu_MC15rd_old_hist[k]->Fill(eemumu_MC15rd_old_values[k].at(i), eemumu_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)llXX_MC15rd_old_values[k].size(); i++) llXX_MC15rd_old_hist[k]->Fill(llXX_MC15rd_old_values[k].at(i), llXX_MC15rd_old_weights.at(i));
        for (int i = 0; i < (int)hhISR_MC15rd_old_values[k].size(); i++) hhISR_MC15rd_old_hist[k]->Fill(hhISR_MC15rd_old_values[k].at(i), hhISR_MC15rd_old_weights.at(i));
    ...
    for (int k = 0; k < (int)variable_names.size(); k++) { // draw
        ...
        c_temp->SaveAs((variable_names.at(k) + "_MC15rd_old_vs_MC15rd.png").c_str());
    ...
    // free
    delete[] MC_values;
    delete[] charged_MC15rd_old_values;
    delete[] mixed_MC15rd_old_values;
    delete[] uubar_MC15rd_old_values;
    delete[] ddbar_MC15rd_old_values;
    delete[] ssbar_MC15rd_old_values;
    delete[] ccbar_MC15rd_old_values;
    delete[] taupair_MC15rd_old_values;
    delete[] mumu_MC15rd_old_values;
    delete[] gg_MC15rd_old_values;
    delete[] ee_MC15rd_old_values;
    delete[] eeee_MC15rd_old_values;
    delete[] eemumu_MC15rd_old_values;
    delete[] llXX_MC15rd_old_values;
    delete[] hhISR_MC15rd_old_values;
    ...
    for (int k = 0; k < Nvar_num; k++) {
        delete Stack[k];
        delete charged_MC15rd_old_hist[k];
        delete mixed_MC15rd_old_hist[k];
        delete uubar_MC15rd_old_hist[k];
        delete ddbar_MC15rd_old_hist[k];
        delete ssbar_MC15rd_old_hist[k];
        delete ccbar_MC15rd_old_hist[k];
        delete taupair_MC15rd_old_hist[k];
        delete mumu_MC15rd_old_hist[k];
        delete gg_MC15rd_old_hist[k];
        delete ee_MC15rd_old_hist[k];
        delete eeee_MC15rd_old_hist[k];
        delete eemumu_MC15rd_old_hist[k];
        delete llXX_MC15rd_old_hist[k];
        delete hhISR_MC15rd_old_hist[k];
    ...
    free(Stack);
    free(charged_MC15rd_old_hist);
    free(mixed_MC15rd_old_hist);
    free(uubar_MC15rd_old_hist);
    free(ddbar_MC15rd_old_hist);
    free(ssbar_MC15rd_old_hist);
    free(ccbar_MC15rd_old_hist);
    free(taupair_MC15rd_old_hist);
    free(mumu_MC15rd_old_hist);
    free(gg_MC15rd_old_hist);
    free(ee_MC15rd_old_hist);
    free(eeee_MC15rd_old_hist);
    free(eemumu_MC15rd_old_hist);
    free(llXX_MC15rd_old_hist);
    free(hhISR_MC15rd_old_hist);
