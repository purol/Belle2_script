...
void GetNominalNevt(const char* dirname, const char* included_string, const char* type, const char* sample, double weight_var = 1.0, std::string CorrectionType = "otherwise") { // get nominal PDF with appropriate correction
    ...
    */
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        tree_Bsig->SetBranchAddress("Bsig_isSignal", &Bsig_isSignal);
...
int main(int argc, char* argv[]) {
    ...
    const char* dirname_SIGNAL = "/home/belle2/junewoo/storage_ghi/Analysis/KumoiRD/SIGNAL_analysis/validation_v009/final_output_root_after_MVA_Application_after_cut/Merge";
