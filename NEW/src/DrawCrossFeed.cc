...
# define Nbin_MXs_reco 3
# define Nbin_MXs_true 3

/* ====================================== */

void GetNominalNevt(const char* dirname, const char* included_string, const char* type, const char* sample, double Nevt_matrix[Nbin_MXs_reco][Nbin_MXs_true], double weight_var = 1.0, std::string CorrectionType = "otherwise") { // get nominal PDF with appropriate correction
    /*
    ...
    */
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        for (unsigned int j = 0; j < tree_upsilon->GetEntries(); j++) { // Fill
            ...
            Nevt_matrix[MXs_reco_index][MXs_true_index] = Nevt_matrix[MXs_reco_index][MXs_true_index] + total_weight;
...
int main(int argc, char* argv[]) {
    ...
    double Nevt_matrix[Nbin_MXs_reco][Nbin_MXs_true] = { 0.0 };
    ...
    GetNominalNevt(dirname_SIGNAL, "B2Knunu", "Bplus", "SIGNAL", Nevt_matrix, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Knunu"), "B2Knunu");
    GetNominalNevt(dirname_SIGNAL, "B2Kstarnunu", "Bplus", "SIGNAL", Nevt_matrix, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Kstarnunu"), "otherwise");
    GetNominalNevt(dirname_SIGNAL, "B2Xsnunu", "Bplus", "SIGNAL", Nevt_matrix, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Xsnunu"), "B2Xsnunu");
    GetNominalNevt(dirname_SIGNAL, "B02K0nunu", "Bzero", "SIGNAL", Nevt_matrix, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02K0nunu"), "B02K0nunu");
    GetNominalNevt(dirname_SIGNAL, "B02Kstar0nunu", "Bzero", "SIGNAL", Nevt_matrix, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Kstar0nunu"), "otherwise");
    GetNominalNevt(dirname_SIGNAL, "B02Xsnunu", "Bzero", "SIGNAL", Nevt_matrix, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Xsnunu"), "B02Xsnunu");
