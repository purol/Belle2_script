        ...
        */
        ...
        for (unsigned int i = 0; i < names.size(); i++) {
            ...
            if (DoesItHaveXsBranch) {
                ...
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCcomb__bc", &temp_DecayBDataToTree[0]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch1__bc", &temp_DecayBDataToTree[1]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch2__bc", &temp_DecayBDataToTree[2]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch3__bc", &temp_DecayBDataToTree[3]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch4__bc", &temp_DecayBDataToTree[4]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch5__bc", &temp_DecayBDataToTree[5]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch6__bc", &temp_DecayBDataToTree[6]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch7__bc", &temp_DecayBDataToTree[7]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch8__bc", &temp_DecayBDataToTree[8]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch9__bc", &temp_DecayBDataToTree[9]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch10__bc", &temp_DecayBDataToTree[10]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch11__bc", &temp_DecayBDataToTree[11]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch12__bc", &temp_DecayBDataToTree[12]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch13__bc", &temp_DecayBDataToTree[13]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch14__bc", &temp_DecayBDataToTree[14]);
                temp_tree->SetBranchAddress("nParticlesInList__boB__pl__clMCch15__bc", &temp_DecayBDataToTree[15]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCcomb__bc", &temp_DecayBDataToTree[16]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch16__bc", &temp_DecayBDataToTree[17]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch17__bc", &temp_DecayBDataToTree[18]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch18__bc", &temp_DecayBDataToTree[29]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch19__bc", &temp_DecayBDataToTree[20]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch20__bc", &temp_DecayBDataToTree[21]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch21__bc", &temp_DecayBDataToTree[22]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch22__bc", &temp_DecayBDataToTree[23]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch23__bc", &temp_DecayBDataToTree[24]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch24__bc", &temp_DecayBDataToTree[25]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch25__bc", &temp_DecayBDataToTree[26]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch26__bc", &temp_DecayBDataToTree[27]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch27__bc", &temp_DecayBDataToTree[28]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch28__bc", &temp_DecayBDataToTree[29]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch29__bc", &temp_DecayBDataToTree[30]);
                temp_tree->SetBranchAddress("nParticlesInList__boB0__clMCch30__bc", &temp_DecayBDataToTree[31]);
