...
void AddSample(HistFactory::Channel* channel, const char* fname, int MXs_bin, const double expmu, double qq_CAL, double qq_CAL_relativeuncer, double bkg_norm_relativeuncer) {
	// MXs_bin: reco bin
...
int WorkSpace_side() {
	...
	AddSample(&channel_MXs2, fname_MXs2, 2, expmu, 1.0292, 0.1594, 0.2);
	AddSample(&channel_MXs3, fname_MXs3, 3, expmu, 0.8499, 0.0976, 0.2);
