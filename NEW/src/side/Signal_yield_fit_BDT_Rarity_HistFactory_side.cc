            ...
            if (pdftype == PDFtype::nominal) {}
                ...
                if (strcmp(sample, "SIGNAL") == 0) { // it works only when the sample is signal
                    if (std::abs(Btag_isSignal - 1.0) < MyEPSILON) { // it is applied only when Btag is correct
                        ...
                        if (strcmp(type, "Bplus") == 0) {
                            if (std::abs(Btag_ID - 0.0) < MyEPSILON) New_Correction_FEI = 0.761553;
                            else if (std::abs(Btag_ID - 1.0) < MyEPSILON) New_Correction_FEI = 0.761553;
                            else if (std::abs(Btag_ID - 3.0) < MyEPSILON) New_Correction_FEI = 0.761553;
                            else if (std::abs(Btag_ID - 4.0) < MyEPSILON) New_Correction_FEI = 0.761553;
                            else if (std::abs(Btag_ID - 15.0) < MyEPSILON) New_Correction_FEI = 0.655428;
                            else if (std::abs(Btag_ID - 16.0) < MyEPSILON) New_Correction_FEI = 0.655428;
                            else if (std::abs(Btag_ID - 18.0) < MyEPSILON) New_Correction_FEI = 0.655428;
                            else if (std::abs(Btag_ID - 19.0) < MyEPSILON) New_Correction_FEI = 0.655428;
                            else if (std::abs(Btag_ID - 23.0) < MyEPSILON) New_Correction_FEI = 0.130498;
                            else if (std::abs(Btag_ID - 24.0) < MyEPSILON) New_Correction_FEI = 0.130498;
...
int main()
{
    ...
    const char* MC_dirname_SIGNAL = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD_LS_MC_side/SIGNAL_analysis/test_v000/final_output_root_after_MVA_Application_after_cut/Merge";

    const char* MC_dirname_CHG = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD_LS_MC_side/CHG_analysis/test_v000/final_output_root_after_MVA_Application_after_cut/Merge";
    const char* MC_dirname_MIX = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD_LS_MC_side/MIX_analysis/test_v000/final_output_root_after_MVA_Application_after_cut/Merge";
    const char* MC_dirname_UUBAR = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD_LS_MC_side/UUBAR_analysis/test_v000/final_output_root_after_MVA_Application_after_cut/Merge";
    const char* MC_dirname_DDBAR = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD_LS_MC_side/DDBAR_analysis/test_v000/final_output_root_after_MVA_Application_after_cut/Merge";
