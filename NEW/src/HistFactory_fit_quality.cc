...
int main(int argc, char* argv[]) {
    ...
    else if ((std::string(argv[1]) == std::string("nuisanceLOADNevt")) || (std::string(argv[1]) == std::string("nuisanceLOADNevtLOADNuisance"))) { // check the power of nuisance parameters
        if (argc == 6) {
            injected_mu = -1;
            eps = std::atof(argv[2]);
            indicator = std::atoi(argv[3]);
