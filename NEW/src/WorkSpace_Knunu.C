...
void AddSample(HistFactory::Channel* channel, const char* fname, int MXs_bin, const double expmu, double qq_CAL, double qq_CAL_relativeuncer, double FBDT_CAL, double FBDT_CAL_relativeuncer, double bkg_norm_relativeuncer) {
	...
	CHG_temp.AddShapeSys("CHG_additional_uncorr_uncer", RooStats::HistFactory::Constraint::Type::Gaussian, "CHG_rel_uncer", fname, "");
	...
	MIX_temp.AddShapeSys("MIX_additional_uncorr_uncer", RooStats::HistFactory::Constraint::Type::Gaussian, "MIX_rel_uncer", fname, "");
	...
	UUBAR_temp.AddShapeSys("UUBAR_additional_uncorr_uncer", RooStats::HistFactory::Constraint::Type::Gaussian, "UUBAR_rel_uncer", fname, "");
	...
	DDBAR_temp.AddShapeSys("DDBAR_additional_uncorr_uncer", RooStats::HistFactory::Constraint::Type::Gaussian, "DDBAR_rel_uncer", fname, "");
	...
	SSBAR_temp.AddShapeSys("SSBAR_additional_uncorr_uncer", RooStats::HistFactory::Constraint::Type::Gaussian, "SSBAR_rel_uncer", fname, "");
	...
	CHARM_temp.AddShapeSys("CHARM_additional_uncorr_uncer", RooStats::HistFactory::Constraint::Type::Gaussian, "CHARM_rel_uncer", fname, "");
