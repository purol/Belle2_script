...
int main(int argc, char* argv[]) // offres total: 42.329/fb, on-resonance total: 365.37/fb
{
    ...
    */
    ...
    // input file
    std::string off_data = ("/home/belle2/junewoo/storage_ghi/Analysis/" + std::string(argv[6]) + "_LS_data_offside/SIGNAL_analysis/validation_" + std::string(argv[7]) + "/final_output_data").c_str();
   
    std::string off_MC_UUBAR_validation = ("/home/belle2/junewoo/storage_ghi/Analysis/" + std::string(argv[6]) + "_LS_MC_offside/UUBAR_analysis/validation_" + std::string(argv[7]) + "/final_output_data").c_str();
    std::string off_MC_DDBAR_validation = ("/home/belle2/junewoo/storage_ghi/Analysis/" + std::string(argv[6]) + "_LS_MC_offside/DDBAR_analysis/validation_" + std::string(argv[7]) + "/final_output_data").c_str();
    std::string off_MC_SSBAR_validation = ("/home/belle2/junewoo/storage_ghi/Analysis/" + std::string(argv[6]) + "_LS_MC_offside/SSBAR_analysis/validation_" + std::string(argv[7]) + "/final_output_data").c_str();
    std::string off_MC_CHARM_validation = ("/home/belle2/junewoo/storage_ghi/Analysis/" + std::string(argv[6]) + "_LS_MC_offside/CHARM_analysis/validation_" + std::string(argv[7]) + "/final_output_data").c_str();
    ...
    // save model again
    std::fstream out_stream_2(("/home/belle2/junewoo/storage_b1/bsub/Analysis/GridSearch_BDTc/" + std::string(argv[6]) + "_side_" + std::string(argv[7]) + "/Continuum.weightfile").c_str(), std::ios_base::out | std::ios_base::trunc);
