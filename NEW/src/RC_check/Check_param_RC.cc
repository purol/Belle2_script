...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    const char* fname = strdup(("./KumoiRD_" + std::string(argv[1]) + "/set1/PDFandDATA_workspace.root").c_str());
    ...
    PrintNevtFile(w, ("./KumoiRD_" + std::string(argv[1]) + "/set1/Nominal_Nevt.txt").c_str());
