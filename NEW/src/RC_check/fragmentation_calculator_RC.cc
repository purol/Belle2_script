...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    for (int bin = 0; bin < corrector_Fragmentation.GetNMxsBin(Corrector_Fragmentation::Sample::gamma); bin++) {
        for (int category = 0; category < corrector_Fragmentation.GetNCategory(Corrector_Fragmentation::Sample::gamma); category++) {
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B2Knunu", "Bplus", "SIGNAL", Nevt_WhenPlusOneSigma, bin, category, true, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Knunu"), "B2Knunu");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B2Kstarnunu", "Bplus", "SIGNAL", Nevt_WhenPlusOneSigma, bin, category, true, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Kstarnunu"), "otherwise");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B2Xsnunu", "Bplus", "SIGNAL", Nevt_WhenPlusOneSigma, bin, category, true, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Xsnunu"), "B2Xsnunu");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B02K0nunu", "Bzero", "SIGNAL", Nevt_WhenPlusOneSigma, bin, category, true, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02K0nunu"), "B02K0nunu");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B02Kstar0nunu", "Bzero", "SIGNAL", Nevt_WhenPlusOneSigma, bin, category, true, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Kstar0nunu"), "otherwise");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B02Xsnunu", "Bzero", "SIGNAL", Nevt_WhenPlusOneSigma, bin, category, true, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Xsnunu"), "B02Xsnunu");

            GetOneSigmaNevt(MC_dirname_CHG.c_str(), "root", "Bplus", "CHG", Nevt_WhenPlusOneSigma, bin, category, true, ObtainWeight("CHG", MCTYPE, "validation", "CHG"), "otherwise");
            GetOneSigmaNevt(MC_dirname_MIX.c_str(), "root", "Bzero", "MIX", Nevt_WhenPlusOneSigma, bin, category, true, ObtainWeight("MIX", MCTYPE, "validation", "MIX"), "otherwise");
        }
    }
    /* ====================================== */
    ...
    for (int bin = 0; bin < corrector_Fragmentation.GetNMxsBin(Corrector_Fragmentation::Sample::gamma); bin++) {
        for (int category = 0; category < corrector_Fragmentation.GetNCategory(Corrector_Fragmentation::Sample::gamma); category++) {
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B2Knunu", "Bplus", "SIGNAL", Nevt_WhenMinusOneSigma, bin, category, false, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Knunu"), "B2Knunu");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B2Kstarnunu", "Bplus", "SIGNAL", Nevt_WhenMinusOneSigma, bin, category, false, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Kstarnunu"), "otherwise");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B2Xsnunu", "Bplus", "SIGNAL", Nevt_WhenMinusOneSigma, bin, category, false, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Xsnunu"), "B2Xsnunu");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B02K0nunu", "Bzero", "SIGNAL", Nevt_WhenMinusOneSigma, bin, category, false, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02K0nunu"), "B02K0nunu");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B02Kstar0nunu", "Bzero", "SIGNAL", Nevt_WhenMinusOneSigma, bin, category, false, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Kstar0nunu"), "otherwise");
            GetOneSigmaNevt(MC_dirname_SIGNAL.c_str(), "B02Xsnunu", "Bzero", "SIGNAL", Nevt_WhenMinusOneSigma, bin, category, false, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Xsnunu"), "B02Xsnunu");

            GetOneSigmaNevt(MC_dirname_CHG.c_str(), "root", "Bplus", "CHG", Nevt_WhenMinusOneSigma, bin, category, false, ObtainWeight("CHG", MCTYPE, "validation", "CHG"), "otherwise");
            GetOneSigmaNevt(MC_dirname_MIX.c_str(), "root", "Bzero", "MIX", Nevt_WhenMinusOneSigma, bin, category, false, ObtainWeight("MIX", MCTYPE, "validation", "MIX"), "otherwise");
        }
    }
    /* ====================================== */
    ...
    fp = fopen((std::string(argv[3]) + "/Fragmentation_toys_" + std::string(argv[1]) + ".txt").c_str(),"w");
    for (int i = 0; i < NToys; i++) {
        for (int j = 0; j < RarityBins * 5; j++) {
