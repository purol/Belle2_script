...
int main(int argc, char* argv[])
{
    ...
    for (int i = 0; i < NToys; i++) {
        ...
        GetFlucNevt(MC_dirname_SIGNAL, "B2Knunu", "Bplus", "SIGNAL", Nevt_fluc_multiplicity, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Knunu"), "B2Knunu");
        GetFlucNevt(MC_dirname_SIGNAL, "B2Kstarnunu", "Bplus", "SIGNAL", Nevt_fluc_multiplicity, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Kstarnunu"), "otherwise");
        GetFlucNevt(MC_dirname_SIGNAL, "B2Xsnunu", "Bplus", "SIGNAL", Nevt_fluc_multiplicity, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Xsnunu"), "B2Xsnunu");
        GetFlucNevt(MC_dirname_SIGNAL, "B02K0nunu", "Bzero", "SIGNAL", Nevt_fluc_multiplicity, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02K0nunu"), "B02K0nunu");
        GetFlucNevt(MC_dirname_SIGNAL, "B02Kstar0nunu", "Bzero", "SIGNAL", Nevt_fluc_multiplicity, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Kstar0nunu"), "otherwise");
        GetFlucNevt(MC_dirname_SIGNAL, "B02Xsnunu", "Bzero", "SIGNAL", Nevt_fluc_multiplicity, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Xsnunu"), "B02Xsnunu");

        GetFlucNevt(MC_dirname_CHG, "root", "Bplus", "CHG", Nevt_fluc_multiplicity, i, ObtainWeight("CHG", MCTYPE, "validation", "CHG"), "otherwise");
        GetFlucNevt(MC_dirname_MIX, "root", "Bzero", "MIX", Nevt_fluc_multiplicity, i, ObtainWeight("MIX", MCTYPE, "validation", "MIX"), "otherwise");
        GetFlucNevt(MC_dirname_UUBAR, "root", "Continuum", "UUBAR", Nevt_fluc_multiplicity, i, ObtainWeight("UUBAR", MCTYPE, "validation", "UUBAR"), "otherwise");
        GetFlucNevt(MC_dirname_DDBAR, "root", "Continuum", "DDBAR", Nevt_fluc_multiplicity, i, ObtainWeight("DDBAR", MCTYPE, "validation", "DDBAR"), "otherwise");
        GetFlucNevt(MC_dirname_SSBAR, "root", "Continuum", "SSBAR", Nevt_fluc_multiplicity, i, ObtainWeight("SSBAR", MCTYPE, "validation", "SSBAR"), "otherwise");
        GetFlucNevt(MC_dirname_CHARM, "root", "Continuum", "CHARM", Nevt_fluc_multiplicity, i, ObtainWeight("CHARM", MCTYPE, "validation", "CHARM"), "otherwise");
    }
    /* ====================================== */
    ...
    fp = fopen(("multiplicity_toys_" + std::string(argv[1]) + ".txt").c_str(),"w");
    for (int i = 0; i < NToys; i++) {
        for (int j = 0; j < RarityBins * 9; j++) {
