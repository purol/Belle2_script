...
void ApplicationEachFile(const char* filename, const char* BB_weightfile_path, const char* Continuum_weightfile_path, const char* output_path)
{
    ...
    if (DoesItHaveXsBranch) {
        ...
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCcomb__bc", &temp_DecayBDataToTree[0]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch1__bc", &temp_DecayBDataToTree[1]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch2__bc", &temp_DecayBDataToTree[2]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch3__bc", &temp_DecayBDataToTree[3]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch4__bc", &temp_DecayBDataToTree[4]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch5__bc", &temp_DecayBDataToTree[5]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch6__bc", &temp_DecayBDataToTree[6]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch7__bc", &temp_DecayBDataToTree[7]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch8__bc", &temp_DecayBDataToTree[8]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch9__bc", &temp_DecayBDataToTree[9]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch10__bc", &temp_DecayBDataToTree[10]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch11__bc", &temp_DecayBDataToTree[11]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch12__bc", &temp_DecayBDataToTree[12]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch13__bc", &temp_DecayBDataToTree[13]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch14__bc", &temp_DecayBDataToTree[14]);
        theTree->SetBranchAddress("nParticlesInList__boB__pl__clMCch15__bc", &temp_DecayBDataToTree[15]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCcomb__bc", &temp_DecayBDataToTree[16]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch16__bc", &temp_DecayBDataToTree[17]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch17__bc", &temp_DecayBDataToTree[18]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch18__bc", &temp_DecayBDataToTree[29]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch19__bc", &temp_DecayBDataToTree[20]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch20__bc", &temp_DecayBDataToTree[21]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch21__bc", &temp_DecayBDataToTree[22]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch22__bc", &temp_DecayBDataToTree[23]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch23__bc", &temp_DecayBDataToTree[24]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch24__bc", &temp_DecayBDataToTree[25]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch25__bc", &temp_DecayBDataToTree[26]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch26__bc", &temp_DecayBDataToTree[27]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch27__bc", &temp_DecayBDataToTree[28]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch28__bc", &temp_DecayBDataToTree[29]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch29__bc", &temp_DecayBDataToTree[30]);
        theTree->SetBranchAddress("nParticlesInList__boB0__clMCch30__bc", &temp_DecayBDataToTree[31]);
        ...
        for (int i = 0; i < N_Xsu_Kpipi; i++) theTree->SetBranchAddress(("nParticlesInList__boXsu__clKpipi_ch" + std::to_string(i + 1) + "__bc").c_str(), &temp_Xsu_KpipiToTree[i]);
        for (int i = 0; i < N_Xsu_Kpipipi; i++) theTree->SetBranchAddress(("nParticlesInList__boXsu__clKpipipi_ch" + std::to_string(i + 1) + "__bc").c_str(), &temp_Xsu_KpipipiToTree[i]);
        for (int i = 0; i < N_Xsd_Kpipi; i++) theTree->SetBranchAddress(("nParticlesInList__boXsd__clKpipi_ch" + std::to_string(i + 1) + "__bc").c_str(), &temp_Xsd_KpipiToTree[i]);
        for (int i = 0; i < N_Xsd_Kpipipi; i++) theTree->SetBranchAddress(("nParticlesInList__boXsd__clKpipipi_ch" + std::to_string(i + 1) + "__bc").c_str(), &temp_Xsd_KpipipiToTree[i]);
    }
...
void FillVariables_Off(const char* filename, std::vector<float> input_vars[Nvar], std::vector<bool>* IsSignal, std::vector<float>* weight, bool tempissignal, float weight_N = 1.0) {
    TFile* input_file = new TFile(filename, "read");
