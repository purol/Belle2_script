    ...
    */
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        for (unsigned int j = 0; j < tree_upsilon->GetEntries(); j++) { // Fill
            ...
            if ((SampleName.c_str(), "CHG") == 0) && (N_Knn > MyEPSILON)) continue;
            else if ((SampleName.c_str(), "CHG") == 0) && (N_Kstarnn > MyEPSILON)) continue;
            else if ((SampleName.c_str(), "MIX") == 0) && (N_K0nn > MyEPSILON)) continue;
            else if ((SampleName.c_str(), "MIX") == 0) && (N_K0starnn > MyEPSILON)) continue;
...
void THStack_Jpsi_FBDT_efficiency() {
    ...
    const char* Jpsi_MC_Knn_before_dirname = "/home/jwpark/storage/BKG_gbasf2/Kokoro_Knn_LS_MC_Jpsi/SIGNAL_analysis/validation_v000/final_output_root_after_MVA_Application/B2Knn";
    const char* Jpsi_MC_Kstarnn_before_dirname = "/home/jwpark/storage/BKG_gbasf2/Kokoro_Knn_LS_MC_Jpsi/SIGNAL_analysis/validation_v000/final_output_root_after_MVA_Application/B2Kstarnn";
    const char* Jpsi_MC_K0nn_before_dirname = "/home/jwpark/storage/BKG_gbasf2/Kokoro_Knn_LS_MC_Jpsi/SIGNAL_analysis/validation_v000/final_output_root_after_MVA_Application/B02K0nn";
    const char* Jpsi_MC_K0starnn_before_dirname = "/home/jwpark/storage/BKG_gbasf2/Kokoro_Knn_LS_MC_Jpsi/SIGNAL_analysis/validation_v000/final_output_root_after_MVA_Application/B02K0starnn";
    const char* Jpsi_data_before_before_dirname = "/home/jwpark/storage/BKG_gbasf2/Kasen_LS_data_Jpsi/SIGNAL_analysis/validation_v000/final_output_root_after_MVA_Application";
    ...
    const char* Jpsi_MC_Knn_after_dirname = "/home/jwpark/storage/BKG_gbasf2/Kokoro_Knn_LS_MC_Jpsi/SIGNAL_analysis/validation_v000/final_output_root_after_MVA_Application_after_cut/B2Knn";
    const char* Jpsi_MC_Kstarnn_after_dirname = "/home/jwpark/storage/BKG_gbasf2/Kokoro_Knn_LS_MC_Jpsi/SIGNAL_analysis/validation_v000/final_output_root_after_MVA_Application_after_cut/B2Kstarnn";
    const char* Jpsi_MC_K0nn_after_dirname = "/home/jwpark/storage/BKG_gbasf2/Kokoro_Knn_LS_MC_Jpsi/SIGNAL_analysis/validation_v000/final_output_root_after_MVA_Application_after_cut/B02K0nn";
    const char* Jpsi_MC_K0starnn_after_dirname = "/home/jwpark/storage/BKG_gbasf2/Kokoro_Knn_LS_MC_Jpsi/SIGNAL_analysis/validation_v000/final_output_root_after_MVA_Application_after_cut/B02K0starnn";
    ...
    LetsFillJpsi_ri(Jpsi_MC_Knn_before_dirname, variable_names, branch_names, Jpsi_MC_values_before, &Jpsi_MC_numbering_before, &weights_before, "Knn");
    LetsFillJpsi_ri(Jpsi_MC_Kstarnn_before_dirname, variable_names, branch_names, Jpsi_MC_values_before, &Jpsi_MC_numbering_before, &weights_before, "Kstarnn");
    LetsFillJpsi_ri(Jpsi_MC_K0nn_before_dirname, variable_names, branch_names, Jpsi_MC_values_before, &Jpsi_MC_numbering_before, &weights_before, "K0nn");
    LetsFillJpsi_ri(Jpsi_MC_K0starnn_before_dirname, variable_names, branch_names, Jpsi_MC_values_before, &Jpsi_MC_numbering_before, &weights_before, "K0starnn");
    ...
    LetsFillJpsi_ri(Jpsi_MC_Knn_after_dirname, variable_names, branch_names, Jpsi_MC_values_after, &Jpsi_MC_numbering_after, &weights_after, "Knn");
    LetsFillJpsi_ri(Jpsi_MC_Kstarnn_after_dirname, variable_names, branch_names, Jpsi_MC_values_after, &Jpsi_MC_numbering_after, &weights_after, "Kstarnn");
    LetsFillJpsi_ri(Jpsi_MC_K0nn_after_dirname, variable_names, branch_names, Jpsi_MC_values_after, &Jpsi_MC_numbering_after, &weights_after, "K0nn");
    LetsFillJpsi_ri(Jpsi_MC_K0starnn_after_dirname, variable_names, branch_names, Jpsi_MC_values_after, &Jpsi_MC_numbering_after, &weights_after, "K0starnn");
