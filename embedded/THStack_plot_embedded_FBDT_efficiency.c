    ...
    CUTOFF(50.0)
{
    ...
    // read Knn weights
    fp = fopen("/home/belle2/junewoo/storage_b1/bsub/systematic/multiplicity_weight.txt", "r");
    fscanf(fp, "%d\n", &NgammaMAX);
...
void THStack_plot_embedded_FBDT_efficiency() {
    ...
    const char* Embedded_MC_UDSCHARM_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/Satori_embedded/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/for_plot/UDSCHARM";
    ...
    const char* Embedded_MC_UDSCHARM_before_FBDT_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/Satori_embedded/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application/for_plot/UDSCHARM";
