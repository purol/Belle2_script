...
void THStack_plot_embedded_FBDT_efficiency() {
    ...
    LetsFillJpsi(Embedded_MC_CHG_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, CAL * Scale_CHG_validation_MC15rd);
    LetsFillJpsi(Embedded_MC_MIX_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, CAL * Scale_MIX_validation_MC15rd);
    LetsFillJpsi(Embedded_MC_UUBAR_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, CAL * Scale_UUBAR_validation_MC15rd);
    LetsFillJpsi(Embedded_MC_DDBAR_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, CAL * Scale_DDBAR_validation_MC15rd);
    LetsFillJpsi(Embedded_MC_SSBAR_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, CAL * Scale_SSBAR_validation_MC15rd);
    LetsFillJpsi(Embedded_MC_CHARM_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, CAL * Scale_CHARM_validation_MC15rd);
