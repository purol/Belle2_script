...
void THStack_plot_embedded_FBDT_efficiency() {
    ...
    LetsFillJpsi(Embedded_MC_CHG_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, FEI_cal_Bc * CAL * ((N_BB_LS1 * (BR_BpBp / (BR_BpBp + BR_B0B0))) / (2.8 * N_BpBp_1invab)));
    LetsFillJpsi(Embedded_MC_MIX_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, FEI_cal_B0 * CAL * ((N_BB_LS1 * (BR_B0B0 / (BR_BpBp + BR_B0B0))) / (2.8 * N_B0B0_1invab)));
