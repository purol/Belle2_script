...
void LetsFillJpsi(const char* dirname, std::vector<std::string> variable_names, std::vector<std::string> branch_names, std::vector<double> variable_values[Nvar_num], std::vector<double>* weights, double weight) {
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        for (unsigned int j = 0; j < tree_upsilon->GetEntries(); j++) { // Fill
            ...
            weights->push_back(FEI_calibration_factor * weight);
        }
        input_file->Close();
...
void THStack_plot_embedded_FBDT_efficiency() {
    ...
    // dirnames
    const char* Embedded_MC_CHG_dirname = "/home/jwpark/storage/BKG_gbasf2/Nazrin_embedded_fixed/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/for_plot/CHG";
    const char* Embedded_MC_MIX_dirname = "/home/jwpark/storage/BKG_gbasf2/Nazrin_embedded_fixed/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/for_plot/MIX";
    const char* Embedded_MC_UDSCHARM_dirname = "/home/jwpark/storage/BKG_gbasf2/Nazrin_embedded_fixed/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/for_plot/UDSCHARM";
    const char* Embedded_data_dirname = "/home/jwpark/storage/BKG_gbasf2/Nazrin_embedded/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/for_plot/data";

    const char* Embedded_MC_CHG_before_FBDT_dirname = "/home/jwpark/storage/BKG_gbasf2/Nazrin_embedded_fixed/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application/for_plot/CHG";
    const char* Embedded_MC_MIX_before_FBDT_dirname = "/home/jwpark/storage/BKG_gbasf2/Nazrin_embedded_fixed/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application/for_plot/MIX";
    const char* Embedded_MC_UDSCHARM_before_FBDT_dirname = "/home/jwpark/storage/BKG_gbasf2/Nazrin_embedded_fixed/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application/for_plot/UDSCHARM";
    const char* Embedded_data_before_FBDT_dirname = "/home/jwpark/storage/BKG_gbasf2/Nazrin_embedded/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application/for_plot/data";
    ...
    std::vector<double> Jpsi_MC_before_FBDT_values[Nvar_num];
    std::vector<double> Jpsi_data_values[Nvar_num];
    std::vector<double> Jpsi_data_before_FBDT_values[Nvar_num];
    ...
    LetsFillJpsi(Embedded_MC_CHG_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, CAL * ((N_BB_LS1 * (BR_BpBp / (BR_BpBp + BR_B0B0))) / (2.8 * N_BpBp_1invab)));
    LetsFillJpsi(Embedded_MC_MIX_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, CAL * ((N_BB_LS1 * (BR_B0B0 / (BR_BpBp + BR_B0B0))) / (2.8 * N_B0B0_1invab)));
    LetsFillJpsi(Embedded_MC_UDSCHARM_before_FBDT_dirname, variable_names, branch_names, Jpsi_MC_before_FBDT_values, &weights_before_FBDT, CAL * 0.361673 / 1.0);
    LetsFill(Embedded_data_before_FBDT_dirname, variable_names, branch_names, Jpsi_data_before_FBDT_values);

    TH1D* MC_one_bin[Nvar_num];
    TH1D* MC_before_one_bin[Nvar_num];
    TH1D* MC_efficiency[Nvar_num];
    TH1D* data_one_bin[Nvar_num];
    TH1D* data_before_one_bin[Nvar_num];
    TH1D* data_efficiency[Nvar_num];
