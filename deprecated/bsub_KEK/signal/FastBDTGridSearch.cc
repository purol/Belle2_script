...
void FillVariables(const char* filename, std::vector<float> input_vars[Nvar], std::vector<bool>* IsSignal, std::vector<float>* weight, bool tempissignal, float weight_N = 1.0, std::string CorrectionType = "otherwise") {
    ...
    */
    ...
    tree_data->SetBranchAddress("Bsig_KSFWVariables_et", &Vars[1]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hoo0", &Vars[2]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hoo1", &Vars[3]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hoo2", &Vars[4]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hoo3", &Vars[5]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hoo4", &Vars[6]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso00", &Vars[7]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso01", &Vars[8]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso02", &Vars[9]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso03", &Vars[10]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso04", &Vars[11]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso01", &Vars[12]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso10", &Vars[13]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso12", &Vars[14]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso14", &Vars[15]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso20", &Vars[16]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso22", &Vars[17]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_hso24", &Vars[18]);
    tree_data->SetBranchAddress("Bsig_KSFWVariables_mm2", &Vars[19]);
    tree_data->SetBranchAddress("Bsig_thrustBm", &Vars[20]);
    tree_data->SetBranchAddress("Bsig_useCMSFrame_p", &Vars[21]);
    tree_data->SetBranchAddress("Btag_CleoConeCS_1", &Vars[22]);
    tree_data->SetBranchAddress("Btag_CleoConeCS_2", &Vars[23]);
    tree_data->SetBranchAddress("Btag_CleoConeCS_3", &Vars[24]);
    tree_data->SetBranchAddress("Btag_CleoConeCS_4", &Vars[25]);
    tree_data->SetBranchAddress("Btag_CleoConeCS_5", &Vars[26]);
    tree_data->SetBranchAddress("Btag_CleoConeCS_6", &Vars[27]);
    tree_data->SetBranchAddress("Btag_CleoConeCS_7", &Vars[28]);
    tree_data->SetBranchAddress("Btag_CleoConeCS_8", &Vars[29]);
    tree_data->SetBranchAddress("Btag_CleoConeCS_9", &Vars[30]);
    tree_data->SetBranchAddress("Btag_cosTBTO", &Vars[31]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_et", &Vars[32]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hoo0", &Vars[33]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hoo1", &Vars[34]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hoo2", &Vars[35]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hoo3", &Vars[36]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hoo4", &Vars[37]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso00", &Vars[38]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso01", &Vars[39]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso02", &Vars[40]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso03", &Vars[41]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso04", &Vars[42]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso10", &Vars[43]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso12", &Vars[44]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso14", &Vars[45]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso20", &Vars[46]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso22", &Vars[47]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_hso24", &Vars[48]);
    tree_data->SetBranchAddress("Btag_KSFWVariables_mm2", &Vars[49]);
    tree_data->SetBranchAddress("Btag_R2", &Vars[50]);
    tree_data->SetBranchAddress("Btag_thrustOm", &Vars[51]);
    tree_data->SetBranchAddress("Btag_useCMSFrame_phi", &Vars[52]);
    tree_data->SetBranchAddress("Btag_useCMSFrame_theta", &Vars[53]);
    tree_data->SetBranchAddress("cleoConeThrust0", &Vars[54]);
    tree_data->SetBranchAddress("cleoConeThrust1", &Vars[55]);
    tree_data->SetBranchAddress("cleoConeThrust2", &Vars[56]);
    tree_data->SetBranchAddress("cleoConeThrust3", &Vars[57]);
    tree_data->SetBranchAddress("cleoConeThrust4", &Vars[58]);
    tree_data->SetBranchAddress("cleoConeThrust5", &Vars[59]);
    tree_data->SetBranchAddress("cleoConeThrust6", &Vars[60]);
    tree_data->SetBranchAddress("cleoConeThrust7", &Vars[61]);
    tree_data->SetBranchAddress("cleoConeThrust8", &Vars[62]);
    tree_data->SetBranchAddress("extraInfo__boEeclv200__bc", &Vars[63]);
    tree_data->SetBranchAddress("extraInfo__boNgammav200__bc", &Vars[64]);
    tree_data->SetBranchAddress("foxWolframR1", &Vars[65]);
    tree_data->SetBranchAddress("foxWolframR2", &Vars[66]);
    tree_data->SetBranchAddress("foxWolframR3", &Vars[67]);
    tree_data->SetBranchAddress("foxWolframR4", &Vars[68]);
    tree_data->SetBranchAddress("harmonicMomentThrust1", &Vars[69]);
    tree_data->SetBranchAddress("harmonicMomentThrust2", &Vars[70]);
    tree_data->SetBranchAddress("harmonicMomentThrust3", &Vars[71]);
    tree_data->SetBranchAddress("harmonicMomentThrust4", &Vars[72]);
    tree_data->SetBranchAddress("missingEnergyOfEventCMS", &Vars[73]);
    tree_data->SetBranchAddress("missingMass2OfEvent", &Vars[74]);
    tree_data->SetBranchAddress("missingMomentumOfEvent", &Vars[75]);
    tree_data->SetBranchAddress("missingMomentumOfEvent_theta", &Vars[76]);
    tree_data->SetBranchAddress("nRemainingTracksInEvent", &Vars[77]);
    tree_data->SetBranchAddress("roePTheta__bocleanMask__bc", &Vars[78]);
    tree_data->SetBranchAddress("useTagSideRecoilRestFrame__bodaughter__bo1__cmE__bc__cm0__bc", &Vars[79]);
    tree_data->SetBranchAddress("useTagSideRecoilRestFrame__bodaughter__bo1__cmp__bc__cm0__bc", &Vars[80]);
    tree_data->SetBranchAddress("visibleEnergyOfEventCMS", &Vars[81]);
...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    // input file
    std::string SIGNAL_input_train = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/SIGNAL_analysis/train_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string CHG_input_train = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/CHG_analysis/train_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string MIX_input_train = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/MIX_analysis/train_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string UUBAR_input_train = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/UUBAR_analysis/train_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string DDBAR_input_train = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/DDBAR_analysis/train_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string SSBAR_input_train = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/SSBAR_analysis/train_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string CHARM_input_train = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/CHARM_analysis/train_" + std::string(argv[7]) + "/final_output_data_signal_region";

    std::string SIGNAL_input_test = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/SIGNAL_analysis/test_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string CHG_input_test = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/CHG_analysis/test_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string MIX_input_test = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/MIX_analysis/test_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string UUBAR_input_test = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/UUBAR_analysis/test_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string DDBAR_input_test = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/DDBAR_analysis/test_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string SSBAR_input_test = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/SSBAR_analysis/test_" + std::string(argv[7]) + "/final_output_data_signal_region";
    std::string CHARM_input_test = "/home/belle2/junewoo/storage_b1/bsub/Analysis/" + std::string(argv[6]) + "/CHARM_analysis/test_" + std::string(argv[7]) + "/final_output_data_signal_region";
