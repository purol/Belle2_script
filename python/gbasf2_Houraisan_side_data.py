...
# photon energy bias correction, it should be applied for data only
ma.correctEnergyBias(inputListNames=['gamma:all'], tableName='PhotonEnergyBiasCorrection_MC14a_Jan2022_V3' , path=my_path)
...
# side band
ma.applyCuts("B+:feiHadronic","Mbc < 5.27",path=my_path)
ma.applyCuts("B0:feiHadronic","Mbc < 5.27",path=my_path)
...
ma.variablesToNtuple(decayString="Upsilon(4S):withoutneutrino",variables=Btag_preselection_vars,filename=output_file,treename="Btag_preselection",path=my_path)
ma.variablesToNtuple(decayString="Upsilon(4S):withoutneutrino",variables=Bsig_preselection_vars,filename=output_file,treename="Bsig_preselection",path=my_path)
ma.variablesToNtuple(decayString="Upsilon(4S):withoutneutrino",variables=U_preselection_vars,filename=output_file,treename="Upsilon_preselection",path=my_path)
...
if(args.inputsample == "MC_Jpsi" or args.inputsample == "MC_BKG_BB_for_Jpsi" or args.inputsample == "MC_Jpsi_SIGNAL"):
    ma.applyCuts("pi+:simple", "sourceObjectIsInList(mu+:fromUpsilonmychargedMuon)==0", path=roe_path_one)
...
if(args.inputsample == "MC_Jpsi" or args.inputsample == "MC_BKG_BB_for_Jpsi" or args.inputsample == "MC_Jpsi_SIGNAL"):
    ma.applyCuts("pi+:simple", "sourceObjectIsInList(mu+:fromUpsilonmychargedMuon)==0", path=roe_path_two)
...
if(args.inputsample == "MC_Jpsi" or args.inputsample == "MC_BKG_BB_for_Jpsi" or args.inputsample == "MC_Jpsi_SIGNAL"):
    track_default += " and sourceObjectIsInList(mu+:fromUpsilonmychargedMuon)==0"
    gamma_default += " and sourceObjectIsInList(mu+:fromUpsilonmychargedMuon)==0"
...
if(args.inputsample=="MC_Jpsi_SIGNAL"):
    ...
    va.variables.addAlias("nParticlesInList__boB__pl__clMC_signal_total_e__bc", "constant(0)")
    va.variables.addAlias("nParticlesInList__boB0__clMC_signal_total_e__bc", "constant(0)")
