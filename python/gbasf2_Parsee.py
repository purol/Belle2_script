...
if args.inputsample != "run_dependent" and args.inputsample != "data_Jpsi":
...
if(args.inputsample == "MC_Jpsi" or args.inputsample == "MC_BKG_BB_for_Jpsi" or args.inputsample == "MC_Jpsi_SIGNAL" or args.inputsample == "data_Jpsi"):
    ...
    ma.reconstructDecay("B+:temp_sig_for_plot -> Xsu:comb J/psi:temp", cut="[Mbc > 5.22] and [abs(deltaE) < 0.2]", path = my_path)
    ma.reconstructDecay("B0:temp_sig_for_plot -> Xsd:comb J/psi:temp", cut="[Mbc > 5.22] and [abs(deltaE) < 0.2]", path = my_path)
    ma.cutAndCopyList("B+:temp_sig", "B+:temp_sig_for_plot", "[Mbc > 5.25] and [abs(deltaE) < 0.1]",path=my_path)
    ma.cutAndCopyList("B0:temp_sig", "B0:temp_sig_for_plot", "[Mbc > 5.25] and [abs(deltaE) < 0.1]",path=my_path)
    ma.cutAndCopyList("J/psi:temp_daughterBsig", "J/psi:temp", "[isDescendantOfList(B+:temp_sig,1) == 1] or [isDescendantOfList(B0:temp_sig,1) == 1]",path=my_path)
    ma.rankByLowest(particleList="J/psi:temp_daughterBsig", variable="random",allowMultiRank=True,outputVariable="Jpsi_random_rank",path=my_path) 
    ma.cutAndCopyList("J/psi:temp_BCS", "J/psi:temp_daughterBsig", "extraInfo(Jpsi_random_rank) == 1",path=my_path)
    ...
    ma.variablesToNtuple(decayString="J/psi:temp_BCS",variables=["dM", "M", "nParticlesInList(mu+:fromJpsimuchargedMuon)", "nParticlesInList(J/psi:temp_daughterBsig)", "nParticlesInList(J/psi:temp)"],filename=JpsiName,treename="JpsiBCS",path=my_path)
    ma.variablesToNtuple(decayString="B+:temp_sig_for_plot",variables=["Mbc", "deltaE"],filename=JpsiName,treename="Bsigplus_Jpsi",path=my_path)
    ma.variablesToNtuple(decayString="B0:temp_sig_for_plot",variables=["Mbc", "deltaE"],filename=JpsiName,treename="Bsigzero_Jpsi",path=my_path)
...
Btag_preselection_vars = vu.create_aliases(list_of_variables = ["chiProb", "extraInfo(SignalProbability)"], wrapper = "daughter(0,{variable})",prefix="Btag")
...
U_preselection_vars = ["extraInfo(decayModeID)", "nROE_Tracks(cleanMask)", "roeEextra(cleanMask)"]
if(args.inputsample=="MC_SIGNAL") or (args.inputsample=="MC_Jpsi_SIGNAL"):
...
# For exception
ma.cutAndCopyList("K+:excep_su", "K+:mychargedKaon", cut="isDescendantOfList(Xsu:sig, 1) == 1 and Kaon_mean < -0.5 ", path=roe_path_one)
ma.cutAndCopyList("pi+:excep_su", "pi+:mychargedPion", cut="isDescendantOfList(Xsu:sig, 1) == 1 and Pion_mean < -0.5 ", path=roe_path_one)
ma.variableToSignalSideExtraInfo('Xsu:sig', {'nParticlesInList(K+:excep_su)': 'nKexcep'}, path=roe_path_one)
ma.variableToSignalSideExtraInfo('Xsu:sig', {'nParticlesInList(pi+:excep_su)': 'nPiexcep'}, path=roe_path_one)

# D veto in Bsig
ma.reconstructDecay(decayString="D+:veto1_su -> pi+:sig_su pi-:sig_su pi+:sig_su ", cut="", dmID=1, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto2_su -> pi+:sig_su pi0:sig_su", cut="", dmID=2, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto3_su -> K_S0:sig_su pi+:sig_su", cut="", dmID=3, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto4_su -> K_S0:sig_su pi+:sig_su pi-:sig_su pi+:sig_su ", cut="", dmID=4, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto5_su -> K_S0:sig_su pi+:sig_su pi0:sig_su", cut="", dmID=5, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto6_su -> K+:sig_su pi-:sig_su pi+:sig_su", cut="", dmID=6, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto7_su -> K+:sig_su pi0:sig_su", cut="", dmID=7, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto8_su -> K+:sig_su pi-:sig_su pi+:sig_su pi0:sig_su", cut="", dmID=8, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto9_su -> K+:sig_su K-:sig_su K+:sig_su", cut="", dmID=9, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto10_su -> K+:sig_su K_S0:sig_su", cut="", dmID=10, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto11_su -> K+:sig_su K-:sig_su pi+:sig_su", cut="", dmID=11, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto12_su -> K+:sig_su K-:sig_su K_S0:sig_su pi+:sig_su", cut="", dmID=12, path=roe_path_one)
ma.reconstructDecay(decayString="D+:veto13_su -> K+:sig_su K-:sig_su K+:sig_su pi0:sig_su", cut="", dmID=13, path=roe_path_one)
ma.copyLists(outputListName="D+:vetocomb_su", inputListNames=["D+:veto1_su", "D+:veto2_su", "D+:veto3_su", "D+:veto4_su", "D+:veto5_su", "D+:veto6_su", "D+:veto7_su", "D+:veto8_su", "D+:veto9_su", "D+:veto10_su", "D+:veto11_su", "D+:veto12_su", "D+:veto13_su"], path=roe_path_one)

Dc_yes_su = basf2.create_path()
Dc_no_su = basf2.create_path()
ma.rankByLowest('D+:vetocomb_su', 'abs(dM)', 1, path=Dc_yes_su)
ma.variableToSignalSideExtraInfo('D+:vetocomb_su', {'M': 'Dcvetomass'}, path=Dc_yes_su)
ma.variableToSignalSideExtraInfo('D+:vetocomb_su', {'extraInfo(decayModeID)': 'DcvetodmID'}, path=Dc_yes_su)
ma.variableToSignalSideExtraInfo('D+:vetocomb_su', {'abs(dM)': 'Dcvetoabsdm'}, path=Dc_yes_su)
ma.variableToSignalSideExtraInfo('Xsu:sig', {'constant(-1)': 'Dcvetomass'}, path=Dc_no_su)
ma.variableToSignalSideExtraInfo('Xsu:sig', {'constant(-1)': 'DcvetodmID'}, path=Dc_no_su)
ma.variableToSignalSideExtraInfo('Xsu:sig', {'constant(-1)': 'Dcvetoabsdm'}, path=Dc_no_su)
nDc_su_module = roe_path_one.add_module("VariableToReturnValue", variable="nParticlesInList(D+:vetocomb_su)")
nDc_su_module.if_value(">=1", Dc_yes_su, basf2.AfterConditionPath.CONTINUE)
nDc_su_module.if_value("<1", Dc_no_su, basf2.AfterConditionPath.CONTINUE)

ma.reconstructDecay(decayString="D0:veto1_su -> pi+:sig_su pi-:sig_su", cut="", dmID=1, path=roe_path_one)
ma.reconstructDecay(decayString="D0:veto2_su -> pi+:sig_su pi-:sig_su pi0:sig_su", cut="", dmID=2, path=roe_path_one)
ma.reconstructDecay(decayString="D0:veto3_su -> pi+:sig_su pi-:sig_su K_S0:sig_su", cut="", dmID=3, path=roe_path_one)
ma.reconstructDecay(decayString="D0:veto4_su -> K+:sig_su pi-:sig_su", cut="", dmID=4, path=roe_path_one)
ma.reconstructDecay(decayString="D0:veto5_su -> K+:sig_su pi-:sig_su pi0:sig_su", cut="", dmID=5, path=roe_path_one)
ma.reconstructDecay(decayString="D0:veto6_su -> K+:sig_su K-:sig_su", cut="", dmID=6, path=roe_path_one)
ma.reconstructDecay(decayString="D0:veto7_su -> K+:sig_su K-:sig_su K_S0:sig_su", cut="", dmID=7, path=roe_path_one)
ma.reconstructDecay(decayString="D0:veto8_su -> K+:sig_su pi-:sig_su K_S0:sig_su", cut="", dmID=8, path=roe_path_one)
ma.reconstructDecay(decayString="D0:veto9_su -> K+:sig_su K-:sig_su pi0:sig_su", cut="", dmID=9, path=roe_path_one)
ma.reconstructDecay(decayString="D0:veto10_su -> K_S0:sig_su pi0:sig_su", cut="", dmID=10, path=roe_path_one)
ma.copyLists(outputListName="D0:vetocomb_su", inputListNames=["D0:veto1_su", "D0:veto2_su", "D0:veto3_su", "D0:veto4_su", "D0:veto5_su", "D0:veto6_su", "D0:veto7_su", "D0:veto8_su", "D0:veto9_su", "D0:veto10_su"], path=roe_path_one)

Dn_yes_su = basf2.create_path()
Dn_no_su = basf2.create_path()
ma.rankByLowest('D0:vetocomb_su', 'abs(dM)', 1, path=Dn_yes_su)
ma.variableToSignalSideExtraInfo('D0:vetocomb_su', {'M': 'Dnvetomass'}, path=Dn_yes_su)
ma.variableToSignalSideExtraInfo('D0:vetocomb_su', {'extraInfo(decayModeID)': 'DnvetodmID'}, path=Dn_yes_su)
ma.variableToSignalSideExtraInfo('D0:vetocomb_su', {'abs(dM)': 'Dnvetoabsdm'}, path=Dn_yes_su)
ma.variableToSignalSideExtraInfo('Xsu:sig', {'constant(-1)': 'Dnvetomass'}, path=Dn_no_su)
ma.variableToSignalSideExtraInfo('Xsu:sig', {'constant(-1)': 'DnvetodmID'}, path=Dn_no_su)
ma.variableToSignalSideExtraInfo('Xsu:sig', {'constant(-1)': 'Dnvetoabsdm'}, path=Dn_no_su)
nDn_su_module = roe_path_one.add_module("VariableToReturnValue", variable="nParticlesInList(D0:vetocomb_su)")
nDn_su_module.if_value(">=1", Dn_yes_su, basf2.AfterConditionPath.CONTINUE)
nDn_su_module.if_value("<1", Dn_no_su, basf2.AfterConditionPath.CONTINUE)
...
# For exception
ma.cutAndCopyList("K+:excep_sd", "K+:mychargedKaon", cut="isDescendantOfList(Xsd:sig, 1) == 1 and Kaon_mean < -0.5 ", path=roe_path_two)
ma.cutAndCopyList("pi+:excep_sd", "pi+:mychargedPion", cut="isDescendantOfList(Xsd:sig, 1) == 1 and Pion_mean < -0.5 ", path=roe_path_two)
ma.variableToSignalSideExtraInfo('Xsd:sig', {'nParticlesInList(K+:excep_sd)': 'nKexcep'}, path=roe_path_two)
ma.variableToSignalSideExtraInfo('Xsd:sig', {'nParticlesInList(pi+:excep_sd)': 'nPiexcep'}, path=roe_path_two)

ma.reconstructDecay(decayString="D+:veto1_sd -> pi+:sig_sd pi-:sig_sd pi+:sig_sd", cut="", dmID=1, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto2_sd -> pi+:sig_sd pi0:sig_sd", cut="", dmID=2, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto3_sd -> K_S0:sig_sd pi+:sig_sd", cut="", dmID=3, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto4_sd -> K_S0:sig_sd pi+:sig_sd pi0:sig_sd", cut="", dmID=4, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto5_sd -> K+:sig_sd pi-:sig_sd pi+:sig_sd", cut="", dmID=5, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto6_sd -> K-:sig_sd pi+:sig_sd pi+:sig_sd", cut="", dmID=6, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto7_sd -> K+:sig_sd pi0:sig_sd", cut="", dmID=7, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto8_sd -> K+:sig_sd K_S0:sig_sd", cut="", dmID=8, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto9_sd -> K+:sig_sd K-:sig_sd K+:sig_sd", cut="", dmID=9, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto10_sd -> K+:sig_sd K-:sig_sd pi+:sig_sd", cut="", dmID=10, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto11_sd -> K+:sig_sd K+:sig_sd pi-:sig_sd", cut="", dmID=11, path=roe_path_two)
ma.reconstructDecay(decayString="D+:veto12_sd -> K+:sig_sd K_S0:sig_sd pi0:sig_sd", cut="", dmID=12, path=roe_path_two)
ma.copyLists(outputListName="D+:vetocomb_sd", inputListNames=["D+:veto1_sd", "D+:veto2_sd", "D+:veto3_sd", "D+:veto4_sd", "D+:veto5_sd", "D+:veto6_sd", "D+:veto7_sd", "D+:veto8_sd", "D+:veto9_sd", "D+:veto10_sd", "D+:veto11_sd", "D+:veto12_sd"], path=roe_path_two)

Dc_yes_sd = basf2.create_path()
Dc_no_sd = basf2.create_path()
ma.rankByLowest('D+:vetocomb_sd', 'abs(dM)', 1, path=Dc_yes_sd)
ma.variableToSignalSideExtraInfo('D+:vetocomb_sd', {'M': 'Dcvetomass'}, path=Dc_yes_sd)
ma.variableToSignalSideExtraInfo('D+:vetocomb_sd', {'extraInfo(decayModeID)': 'DcvetodmID'}, path=Dc_yes_sd)
ma.variableToSignalSideExtraInfo('D+:vetocomb_sd', {'abs(dM)': 'Dcvetoabsdm'}, path=Dc_yes_sd)
ma.variableToSignalSideExtraInfo('Xsd:sig', {'constant(-1)': 'Dcvetomass'}, path=Dc_no_sd)
ma.variableToSignalSideExtraInfo('Xsd:sig', {'constant(-1)': 'DcvetodmID'}, path=Dc_no_sd)
ma.variableToSignalSideExtraInfo('Xsd:sig', {'constant(-1)': 'Dcvetoabsdm'}, path=Dc_no_sd)
nDc_sd_module = roe_path_two.add_module("VariableToReturnValue", variable="nParticlesInList(D+:vetocomb_sd)")
nDc_sd_module.if_value(">=1", Dc_yes_sd, basf2.AfterConditionPath.CONTINUE)
nDc_sd_module.if_value("<1", Dc_no_sd, basf2.AfterConditionPath.CONTINUE)

ma.reconstructDecay(decayString="D0:veto1_sd -> pi+:sig_sd pi-:sig_sd", cut="", dmID=1, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto2_sd -> pi+:sig_sd pi-:sig_sd pi0:sig_sd", cut="", dmID=2, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto3_sd -> K_S0:sig_sd pi+:sig_sd pi-:sig_sd", cut="", dmID=3, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto4_sd -> K_S0:sig_sd pi0:sig_sd", cut="", dmID=4, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto5_sd -> K_S0:sig_sd pi+:sig_sd pi-:sig_sd pi0:sig_sd", cut="", dmID=5, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto6_sd -> K+:sig_sd pi-:sig_sd", cut="", dmID=6, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto7_sd -> K+:sig_sd pi-:sig_sd pi+:sig_sd pi-:sig_sd", cut="", dmID=7, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto8_sd -> K+:sig_sd pi-:sig_sd pi0:sig_sd", cut="", dmID=8, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto9_sd -> K+:sig_sd K-:sig_sd", cut="", dmID=9, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto10_sd -> K+:sig_sd K-:sig_sd K_S0:sig_sd", cut="", dmID=10, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto11_sd -> K+:sig_sd K-:sig_sd pi0:sig_sd", cut="", dmID=11, path=roe_path_two)
ma.reconstructDecay(decayString="D0:veto12_sd -> K+:sig_sd K-:sig_sd pi0:sig_sd K_S0:sig_sd", cut="", dmID=12, path=roe_path_two)
ma.copyLists(outputListName="D0:vetocomb_sd", inputListNames=["D0:veto1_sd", "D0:veto2_sd", "D0:veto3_sd", "D0:veto4_sd", "D0:veto5_sd", "D0:veto6_sd", "D0:veto7_sd", "D0:veto8_sd", "D0:veto9_sd", "D0:veto10_sd", "D0:veto11_sd", "D0:veto12_sd"], path=roe_path_two)

Dn_yes_sd = basf2.create_path()
Dn_no_sd = basf2.create_path()
ma.rankByLowest('D0:vetocomb_sd', 'abs(dM)', 1, path=Dn_yes_sd)
ma.variableToSignalSideExtraInfo('D0:vetocomb_sd', {'M': 'Dnvetomass'}, path=Dn_yes_sd)
ma.variableToSignalSideExtraInfo('D0:vetocomb_sd', {'extraInfo(decayModeID)': 'DnvetodmID'}, path=Dn_yes_sd)
ma.variableToSignalSideExtraInfo('D0:vetocomb_sd', {'abs(dM)': 'Dnvetoabsdm'}, path=Dn_yes_sd)
ma.variableToSignalSideExtraInfo('Xsd:sig', {'constant(-1)': 'Dnvetomass'}, path=Dn_no_sd)
ma.variableToSignalSideExtraInfo('Xsd:sig', {'constant(-1)': 'DnvetodmID'}, path=Dn_no_sd)
ma.variableToSignalSideExtraInfo('Xsd:sig', {'constant(-1)': 'Dnvetoabsdm'}, path=Dn_no_sd)
nDn_sd_module = roe_path_two.add_module("VariableToReturnValue", variable="nParticlesInList(D0:vetocomb_sd)")
nDn_sd_module.if_value(">=1", Dn_yes_sd, basf2.AfterConditionPath.CONTINUE)
nDn_sd_module.if_value("<1", Dn_no_sd, basf2.AfterConditionPath.CONTINUE)
...
ma.fillSignalSideParticleList('Upsilon(4S):onlyone', '^Upsilon(4S):withoutneutrino', roe_path_upsilon)
ma.fillParticleList('gamma:roe', 'isInRestOfEvent == 1 and ' + cluster_selection, path=roe_path_upsilon)
ma.looseMCTruth(list_name = "gamma:roe", path = roe_path_upsilon)
ma.cutAndCopyList("gamma:roe_error0", "gamma:roe", cut="mcErrors == 0", path=roe_path_upsilon)
ma.cutAndCopyList("gamma:roe_error512", "gamma:roe", cut="mcErrors == 512", path=roe_path_upsilon)
ma.cutAndCopyList("gamma:roe_error128", "gamma:roe", cut="mcErrors == 128", path=roe_path_upsilon)
ma.cutAndCopyList("gamma:roe_error132", "gamma:roe", cut="mcErrors == 132", path=roe_path_upsilon)
ma.cutAndCopyList("gamma:roe_errorothers", "gamma:roe", cut="mcErrors != 0 and mcErrors != 512 and mcErrors != 128 and mcErrors != 132", path=roe_path_upsilon)
ma.variableToSignalSideExtraInfo('Upsilon(4S):onlyone', {'totalEnergyOfParticlesInList(gamma:roe_error0)': 'roeE_0'}, path=roe_path_upsilon)
ma.variableToSignalSideExtraInfo('Upsilon(4S):onlyone', {'totalEnergyOfParticlesInList(gamma:roe_error512)': 'roeE_512'}, path=roe_path_upsilon)
ma.variableToSignalSideExtraInfo('Upsilon(4S):onlyone', {'totalEnergyOfParticlesInList(gamma:roe_error128)': 'roeE_128'}, path=roe_path_upsilon)
ma.variableToSignalSideExtraInfo('Upsilon(4S):onlyone', {'totalEnergyOfParticlesInList(gamma:roe_error132)': 'roeE_132'}, path=roe_path_upsilon)
ma.variableToSignalSideExtraInfo('Upsilon(4S):onlyone', {'totalEnergyOfParticlesInList(gamma:roe_errorothers)': 'roeE_others'}, path=roe_path_upsilon)
...
Dvetovar=["daughter(0,extraInfo(Dcvetomass))", "daughter(0,extraInfo(DcvetodmID))", "daughter(0,extraInfo(Dcvetoabsdm))", "daughter(0,extraInfo(Dnvetomass))", "daughter(0,extraInfo(DnvetodmID))", "daughter(0,extraInfo(Dnvetoabsdm))"]
...
Bsig_vars = vu.create_aliases(list_of_variables = Kinematics + Kinematics_CMS + Dvetovar + simpleDvetovar + othervar + continuumsup_vars + vertexXs + [ "daughter(0, M)", "daughter(0, extraInfo(decayModeID))", "daughter(0, extraInfo(KS0_3D_distance))", "daughter(0, extraInfo(Kaon_PID_correction))", "daughter(0, extraInfo(Kaon_PID_rel_uncer_up))", "daughter(0, extraInfo(Kaon_PID_rel_uncer_dn))", "daughter(0, extraInfo(Pion_PID_correction))", "daughter(0, extraInfo(Pion_PID_rel_uncer_up))", "daughter(0, extraInfo(Pion_PID_rel_uncer_dn))", "daughter(0, extraInfo(nKslow1))", "daughter(0, extraInfo(nKslow2))", "daughter(0, extraInfo(nKslow3))", "daughter(0, extraInfo(nPislow1))", "daughter(0, extraInfo(nPislow2))", "daughter(0, extraInfo(nPislow3))", "daughter(0, extraInfo(nKexcep))", "daughter(0, extraInfo(nPiexcep))", "dr", "dz", "daughter(0, daughter(0, dr))", "daughter(0, daughter(0, dz))"], wrapper = "daughter(1,{variable})", prefix="Bsig")

U_vars = Kinematics + Kinematics_CMS + Kinematics_RecoilRestFrame + EvtKinematics + decayhash + othervar + vc.event_shape + leptonInfo + ["extraInfo(Upsilon_rank)",  "nROE_ECLClusters(cleanMask)", "nROE_NeutralECLClusters(cleanMask)", "nROE_KLMClusters", "nROE_Tracks(cleanMask)", "roeEextra(cleanMask)", "roeNeextra(cleanMask)", "useCMSFrame(roeNeextra(cleanMask))", "nROE_ParticlesInList(K_S0:myKaonshort)", "nROE_ParticlesInList(pi0:myneutralPion)", "nROE_ParticlesInList(gamma:mygamma)", "nRemainingTracksInEvent", "MsquaredBsig_op0", "MsquaredBsig_op1", "MsquaredBsig_op2", "MsquaredBsig_op3", "MsquaredBsig_op4", "MsquaredBsig_op7", "roeP(cleanMask)", "roeM(cleanMask)", "roePTheta(cleanMask)", "qsquared", "extraInfo(chiSquared)", "extraInfo(ndf)", "chiProb", "dr", "dz", "extraInfo(roeE_0)", "extraInfo(roeE_512)", "extraInfo(roeE_128)", "extraInfo(roeE_132)", "extraInfo(roeE_others)", "beamE", "nROE_Tracks(looseMask)"]
if(args.inputsample == "MC_Jpsi" or args.inputsample == "MC_BKG_BB_for_Jpsi" or args.inputsample == "MC_Jpsi_SIGNAL" or args.inputsample == "data_Jpsi"):
    U_vars = U_vars + ["nParticlesInList(mu+:fromJpsimuchargedMuon)", "nParticlesInList(J/psi:temp_BCS)", "nParticlesInList(J/psi:temp_daughterBsig)"]
