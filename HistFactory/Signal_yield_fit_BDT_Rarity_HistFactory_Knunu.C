...
void GetKffPDFs_norm(const char* dirname, TH1D* hist[7], double Correction_factor_BR[7], const char* type, int charge, double weight_var = 1.0) { // get Kff uncertainty PDF with appropriate correction
    // Be careful! You should combine this function with `GetNominalPDFs` function!
    // [NOTE] this function conserves total BR!! It is different from `Signal_yield_fit_BDT_Rarity_HistFactory.C`!!
    if (strcmp(type, "Bplus") == 0) {}
    else if (strcmp(type, "Bzero") == 0) {}
    else if (strcmp(type, "Continuum") == 0) {}
    else {
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        for (unsigned int j = 0; j < tree_upsilon->GetEntries(); j++) { // Fill
            ...
            for (int k = 0; k < 7; k++) {
                ...
                Nevts[k] = Nevts[k] + total_weight * (tot_value[0] / tot_value[k]);
            }
...
void Signal_yield_fit_BDT_Rarity_HistFactory_Knunu()
{
    /* ====================================== */
    // Seting CDF module
    cdf.initbypath("/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/SIGNAL_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge/B2Knunu", Scale_Kplus);
    /* ====================================== */
    ...
    TH1D* Xsnunu_nominal = new TH1D("Xsnunu_nominal", "Xsnunu_nominal", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_FEI_charged_p = new TH1D("Xsnunu_FEI_charged_p", "Xsnunu_FEI_charged_p", RarityBins, 0.7, 1.0);
    TH1D* Xsnunu_FEI_charged_m = new TH1D("Xsnunu_FEI_charged_m", "Xsnunu_FEI_charged_m", RarityBins, 0.7, 1.0);
    TH1D* Xsnunu_FEI_neutral_p = new TH1D("Xsnunu_FEI_neutral_p", "Xsnunu_FEI_neutral_p", RarityBins, 0.7, 1.0);
    TH1D* Xsnunu_FEI_neutral_m = new TH1D("Xsnunu_FEI_neutral_m", "Xsnunu_FEI_neutral_m", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_pi0_p = new TH1D("Xsnunu_pi0_p", "Xsnunu_pi0_p", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_pi0_m = new TH1D("Xsnunu_pi0_m", "Xsnunu_pi0_m", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_track_p = new TH1D("Xsnunu_track_p", "Xsnunu_track_p", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_track_m = new TH1D("Xsnunu_track_m", "Xsnunu_track_m", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_KS0_p = new TH1D("Xsnunu_KS0_p", "Xsnunu_KS0_p", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_KS0_m = new TH1D("Xsnunu_KS0_m", "Xsnunu_KS0_m", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_KID_p = new TH1D("Xsnunu_KID_p", "Xsnunu_KID_p", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_KID_m = new TH1D("Xsnunu_KID_m", "Xsnunu_KID_m", RarityBins, 0.7, 1.0);
    ...
    TH1D* Xsnunu_Kff1_p = new TH1D("Xsnunu_Kff1_p", "Xsnunu_Kff1_p", RarityBins, 0.7, 1.0);
    TH1D* Xsnunu_Kff1_m = new TH1D("Xsnunu_Kff1_m", "Xsnunu_Kff1_m", RarityBins, 0.7, 1.0);
    TH1D* Xsnunu_Kff2_p = new TH1D("Xsnunu_Kff2_p", "Xsnunu_Kff2_p", RarityBins, 0.7, 1.0);
    TH1D* Xsnunu_Kff2_m = new TH1D("Xsnunu_Kff2_m", "Xsnunu_Kff2_m", RarityBins, 0.7, 1.0);
    TH1D* Xsnunu_Kff3_p = new TH1D("Xsnunu_Kff3_p", "Xsnunu_Kff3_p", RarityBins, 0.7, 1.0);
    TH1D* Xsnunu_Kff3_m = new TH1D("Xsnunu_Kff3_m", "Xsnunu_Kff3_m", RarityBins, 0.7, 1.0);
    ...
    const char* MC_dirname_Knunu = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/SIGNAL_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge/B2Knunu";
    const char* MC_dirname_Kstarnunu = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/SIGNAL_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge/B2Kstarnunu";
    const char* MC_dirname_Xsununu = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/SIGNAL_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge/B2Xsnunu";
    const char* MC_dirname_K0nunu = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/SIGNAL_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge/B02K0nunu";
    const char* MC_dirname_K0starnunu = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/SIGNAL_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge/B02K0starnunu";
    const char* MC_dirname_Xsdnunu = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/SIGNAL_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge/B02Xsnunu";

    const char* MC_dirname_CHG = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/CHG_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge";
    const char* MC_dirname_MIX = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/MIX_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge";
    const char* MC_dirname_UUBAR = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/UUBAR_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge";
    const char* MC_dirname_DDBAR = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/DDBAR_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge";
    const char* MC_dirname_SSBAR = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/SSBAR_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge";
    const char* MC_dirname_CHARM = "/home/jwpark/storage/BKG_gbasf2/Izayoi_release5/CHARM_analysis/test_v002/final_output_root_after_MVA_Application_after_cut/BCS_only/Merge";
    /* ====================================== */
    ...
    GetNominalPDFs(MC_dirname_Kstarnunu, Xsnunu_nominal, "Bplus", Scale_Kplusstar);
    GetNominalPDFs(MC_dirname_Xsununu, Xsnunu_nominal, "Bplus", Scale_Xsu_nonresonant);
    GetNominalPDFs(MC_dirname_K0nunu, Xsnunu_nominal, "Bzero", Scale_K0);
    GetNominalPDFs(MC_dirname_K0starnunu, Xsnunu_nominal, "Bzero", Scale_K0star);
    GetNominalPDFs(MC_dirname_Xsdnunu, Xsnunu_nominal, "Bzero", Scale_Xsd_nonresonant);
    ...
    GetFEIPDFs(MC_dirname_Kstarnunu, Xsnunu_FEI_charged_p, "Bplus", true, Scale_Kplusstar);
    GetFEIPDFs(MC_dirname_Xsununu, Xsnunu_FEI_charged_p, "Bplus", true, Scale_Xsu_nonresonant);
    GetNominalPDFs(MC_dirname_K0nunu, Xsnunu_FEI_charged_p, "Bzero", Scale_K0);
    GetNominalPDFs(MC_dirname_K0starnunu, Xsnunu_FEI_charged_p, "Bzero", Scale_K0star);
    GetNominalPDFs(MC_dirname_Xsdnunu, Xsnunu_FEI_charged_p, "Bzero", Scale_Xsd_nonresonant);

    GetFEIPDFs(MC_dirname_Knunu, Signal_FEI_charged_m, "Bplus", false, Scale_Kplus);
    GetFEIPDFs(MC_dirname_Kstarnunu, Xsnunu_FEI_charged_m, "Bplus", false, Scale_Kplusstar);
    GetFEIPDFs(MC_dirname_Xsununu, Xsnunu_FEI_charged_m, "Bplus", false, Scale_Xsu_nonresonant);
    GetNominalPDFs(MC_dirname_K0nunu, Xsnunu_FEI_charged_m, "Bzero", Scale_K0);
    GetNominalPDFs(MC_dirname_K0starnunu, Xsnunu_FEI_charged_m, "Bzero", Scale_K0star);
    GetNominalPDFs(MC_dirname_Xsdnunu, Xsnunu_FEI_charged_m, "Bzero", Scale_Xsd_nonresonant);

    GetNominalPDFs(MC_dirname_Knunu, Signal_FEI_neutral_p, "Bplus", Scale_Kplus);
    GetNominalPDFs(MC_dirname_Kstarnunu, Xsnunu_FEI_neutral_p, "Bplus", Scale_Kplusstar);
    GetNominalPDFs(MC_dirname_Xsununu, Xsnunu_FEI_neutral_p, "Bplus", Scale_Xsu_nonresonant);
    GetFEIPDFs(MC_dirname_K0nunu, Xsnunu_FEI_neutral_p, "Bzero", true, Scale_K0);
    GetFEIPDFs(MC_dirname_K0starnunu, Xsnunu_FEI_neutral_p, "Bzero", true, Scale_K0star);
    GetFEIPDFs(MC_dirname_Xsdnunu, Xsnunu_FEI_neutral_p, "Bzero", true, Scale_Xsd_nonresonant);

    GetNominalPDFs(MC_dirname_Knunu, Signal_FEI_neutral_m, "Bplus", Scale_Kplus);
    GetNominalPDFs(MC_dirname_Kstarnunu, Xsnunu_FEI_neutral_m, "Bplus", Scale_Kplusstar);
    GetNominalPDFs(MC_dirname_Xsununu, Xsnunu_FEI_neutral_m, "Bplus", Scale_Xsu_nonresonant);
    GetFEIPDFs(MC_dirname_K0nunu, Xsnunu_FEI_neutral_m, "Bzero", false, Scale_K0);
    GetFEIPDFs(MC_dirname_K0starnunu, Xsnunu_FEI_neutral_m, "Bzero", false, Scale_K0star);
    GetFEIPDFs(MC_dirname_Xsdnunu, Xsnunu_FEI_neutral_m, "Bzero", false, Scale_Xsd_nonresonant);

    // get pi0 uncertainty pdfs
    GetPi0PDFs(MC_dirname_Knunu, Signal_pi0_p, "Bplus", true, Scale_Kplus);
    GetPi0PDFs(MC_dirname_Kstarnunu, Xsnunu_pi0_p, "Bplus", true, Scale_Kplusstar);
    GetPi0PDFs(MC_dirname_Xsununu, Xsnunu_pi0_p, "Bplus", true, Scale_Xsu_nonresonant);
    GetPi0PDFs(MC_dirname_K0nunu, Xsnunu_pi0_p, "Bzero", true, Scale_K0);
    GetPi0PDFs(MC_dirname_K0starnunu, Xsnunu_pi0_p, "Bzero", true, Scale_K0star);
    GetPi0PDFs(MC_dirname_Xsdnunu, Xsnunu_pi0_p, "Bzero", true, Scale_Xsd_nonresonant);
    ...
    GetPi0PDFs(MC_dirname_Kstarnunu, Xsnunu_pi0_m, "Bplus", false, Scale_Kplusstar);
    GetPi0PDFs(MC_dirname_Xsununu, Xsnunu_pi0_m, "Bplus", false, Scale_Xsu_nonresonant);
    GetPi0PDFs(MC_dirname_K0nunu, Xsnunu_pi0_m, "Bzero", false, Scale_K0);
    GetPi0PDFs(MC_dirname_K0starnunu, Xsnunu_pi0_m, "Bzero", false, Scale_K0star);
    GetPi0PDFs(MC_dirname_Xsdnunu, Xsnunu_pi0_m, "Bzero", false, Scale_Xsd_nonresonant);
    ...
    GetTrackPDFs(MC_dirname_Kstarnunu, Xsnunu_track_p, "Bplus", true, Scale_Kplusstar);
    GetTrackPDFs(MC_dirname_Xsununu, Xsnunu_track_p, "Bplus", true, Scale_Xsu_nonresonant);
    GetTrackPDFs(MC_dirname_K0nunu, Xsnunu_track_p, "Bzero", true, Scale_K0);
    GetTrackPDFs(MC_dirname_K0starnunu, Xsnunu_track_p, "Bzero", true, Scale_K0star);
    GetTrackPDFs(MC_dirname_Xsdnunu, Xsnunu_track_p, "Bzero", true, Scale_Xsd_nonresonant);
    ...
    GetTrackPDFs(MC_dirname_Kstarnunu, Xsnunu_track_m, "Bplus", false, Scale_Kplusstar);
    GetTrackPDFs(MC_dirname_Xsununu, Xsnunu_track_m, "Bplus", false, Scale_Xsu_nonresonant);
    GetTrackPDFs(MC_dirname_K0nunu, Xsnunu_track_m, "Bzero", false, Scale_K0);
    GetTrackPDFs(MC_dirname_K0starnunu, Xsnunu_track_m, "Bzero", false, Scale_K0star);
    GetTrackPDFs(MC_dirname_Xsdnunu, Xsnunu_track_m, "Bzero", false, Scale_Xsd_nonresonant);
    ...
    GetKS0PDFs(MC_dirname_Kstarnunu, Xsnunu_KS0_p, "Bplus", true, Scale_Kplusstar);
    GetKS0PDFs(MC_dirname_Xsununu, Xsnunu_KS0_p, "Bplus", true, Scale_Xsu_nonresonant);
    GetKS0PDFs(MC_dirname_K0nunu, Xsnunu_KS0_p, "Bzero", true, Scale_K0);
    GetKS0PDFs(MC_dirname_K0starnunu, Xsnunu_KS0_p, "Bzero", true, Scale_K0star);
    GetKS0PDFs(MC_dirname_Xsdnunu, Xsnunu_KS0_p, "Bzero", true, Scale_Xsd_nonresonant);
    ...
    GetKS0PDFs(MC_dirname_Kstarnunu, Xsnunu_KS0_m, "Bplus", false, Scale_Kplusstar);
    GetKS0PDFs(MC_dirname_Xsununu, Xsnunu_KS0_m, "Bplus", false, Scale_Xsu_nonresonant);
    GetKS0PDFs(MC_dirname_K0nunu, Xsnunu_KS0_m, "Bzero", false, Scale_K0);
    GetKS0PDFs(MC_dirname_K0starnunu, Xsnunu_KS0_m, "Bzero", false, Scale_K0star);
    GetKS0PDFs(MC_dirname_Xsdnunu, Xsnunu_KS0_m, "Bzero", false, Scale_Xsd_nonresonant);
    ...
    GetKIDPDFs(MC_dirname_Kstarnunu, Xsnunu_KID_p, "Bplus", true, Scale_Kplusstar);
    GetKIDPDFs(MC_dirname_Xsununu, Xsnunu_KID_p, "Bplus", true, Scale_Xsu_nonresonant);
    GetKIDPDFs(MC_dirname_K0nunu, Xsnunu_KID_p, "Bzero", true, Scale_K0);
    GetKIDPDFs(MC_dirname_K0starnunu, Xsnunu_KID_p, "Bzero", true, Scale_K0star);
    GetKIDPDFs(MC_dirname_Xsdnunu, Xsnunu_KID_p, "Bzero", true, Scale_Xsd_nonresonant);
    ...
    GetKIDPDFs(MC_dirname_Kstarnunu, Xsnunu_KID_m, "Bplus", false, Scale_Kplusstar);
    GetKIDPDFs(MC_dirname_Xsununu, Xsnunu_KID_m, "Bplus", false, Scale_Xsu_nonresonant);
    GetKIDPDFs(MC_dirname_K0nunu, Xsnunu_KID_m, "Bzero", false, Scale_K0);
    GetKIDPDFs(MC_dirname_K0starnunu, Xsnunu_KID_m, "Bzero", false, Scale_K0star);
    GetKIDPDFs(MC_dirname_Xsdnunu, Xsnunu_KID_m, "Bzero", false, Scale_Xsd_nonresonant);
    ...
    TH1D* Xsnunu_Kff_temp = new TH1D("Xsnunu_Kff_temp", "Xsnunu_Kff_temp", RarityBins, 0.7, 1.0);
    TH1D* Xsnunu_Kff_array[7] = { Xsnunu_Kff_temp, Xsnunu_Kff1_p, Xsnunu_Kff1_m, Xsnunu_Kff2_p, Xsnunu_Kff2_m, Xsnunu_Kff3_p, Xsnunu_Kff3_m };
    double Correction_factor_BR_Kplus[7] = { 0.0 };
    double Correction_factor_BR_Kzero[7] = { 0.0 };

    GetKffPDFs_norm(MC_dirname_Knunu, Signal_Kff_array, Correction_factor_BR_Kplus, "Bplus", 1, Scale_Kplus);
    for (int i = 0; i < 7; i++) GetNominalPDFs(MC_dirname_Kstarnunu, Xsnunu_Kff_array[i], "Bplus", Scale_Kplusstar);
    for (int i = 0; i < 7; i++) {
        ...
        GetNominalPDFs(MC_dirname_Xsununu, Xsnunu_Kff_array[i], "Bplus", Scale_Xsu_nonresonant * non_res_Xsu_correction_factor);
    }
    GetKffPDFs(MC_dirname_K0nunu, Xsnunu_Kff_array, Correction_factor_BR_Kzero, "Bzero", 0, Scale_K0);
    for (int i = 0; i < 7; i++) GetNominalPDFs(MC_dirname_K0starnunu, Xsnunu_Kff_array[i], "Bzero", Scale_K0star);
    for (int i = 0; i < 7; i++) {
        ...
        GetNominalPDFs(MC_dirname_Xsdnunu, Xsnunu_Kff_array[i], "Bzero", Scale_Xsd_nonresonant * non_res_Xsd_correction_factor);
    }
    ...
    /* ====================================== */
    // Save histograms
    TFile* file = new TFile("PDFandDATA_Knunu.root", "RECREATE");
    ...
    Xsnunu_FEI_charged_p->Write();
    Xsnunu_FEI_charged_m->Write();
    Xsnunu_FEI_neutral_p->Write();
    Xsnunu_FEI_neutral_m->Write();
