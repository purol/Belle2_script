...
void Signal_yield_fit_BDT_Rarity_HistFactory()
{
    ...
    TH1D* Signal_KID_uncorrelated = new TH1D("Signal_KID_uncorrelated", "Signal_KID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* CHG_KID_uncorrelated = new TH1D("CHG_KID_uncorrelated", "CHG_KID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* MIX_KID_uncorrelated = new TH1D("MIX_KID_uncorrelated", "MIX_KID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* UUBAR_KID_uncorrelated = new TH1D("UUBAR_KID_uncorrelated", "UUBAR_KID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* DDBAR_KID_uncorrelated = new TH1D("DDBAR_KID_uncorrelated", "DDBAR_KID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* SSBAR_KID_uncorrelated = new TH1D("SSBAR_KID_uncorrelated", "SSBAR_KID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* CHARM_KID_uncorrelated = new TH1D("CHARM_KID_uncorrelated", "CHARM_KID_uncorrelated", RarityBins, 0.7, 1.0);

    // Pion PID uncertainty (uncorrelated)
    TH1D* Signal_PID_uncorrelated = new TH1D("Signal_PID_uncorrelated", "Signal_PID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* CHG_PID_uncorrelated = new TH1D("CHG_PID_uncorrelated", "CHG_PID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* MIX_PID_uncorrelated = new TH1D("MIX_PID_uncorrelated", "MIX_PID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* UUBAR_PID_uncorrelated = new TH1D("UUBAR_PID_uncorrelated", "UUBAR_PID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* DDBAR_PID_uncorrelated = new TH1D("DDBAR_PID_uncorrelated", "DDBAR_PID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* SSBAR_PID_uncorrelated = new TH1D("SSBAR_PID_uncorrelated", "SSBAR_PID_uncorrelated", RarityBins, 0.7, 1.0);
    TH1D* CHARM_PID_uncorrelated = new TH1D("CHARM_PID_uncorrelated", "CHARM_PID_uncorrelated", RarityBins, 0.7, 1.0);
    ...
    // for signal modeling
    const char* MC_dirname_Xsununu_Hpf = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsu_Hpf";
    const char* MC_dirname_Xsdnunu_Hpf = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsd_Hpf";
    const char* MC_dirname_Xsununu_Lpf = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsu_Lpf";
    const char* MC_dirname_Xsdnunu_Lpf = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsd_Lpf";
    const char* MC_dirname_Xsununu_Hmb = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsu_Hmb";
    const char* MC_dirname_Xsdnunu_Hmb = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsd_Hmb";
    const char* MC_dirname_Xsununu_Lmb = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsu_Lmb";
    const char* MC_dirname_Xsdnunu_Lmb = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsd_Lmb";
    const char* MC_dirname_Xsununu_Htransition = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsu_Htransition";
    const char* MC_dirname_Xsdnunu_Htransition = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsd_Htransition";
    const char* MC_dirname_Xsununu_Ltransition = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsu_Ltransition";
    const char* MC_dirname_Xsdnunu_Ltransition = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/Xsd_Ltransition";

    // for fixed mKstar
    const char* MC_dirname_Kstarnunu_mKstarfixed = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/B2Kstarnunu";
    const char* MC_dirname_K0starnunu_mKstarfixed = "/home/jwpark/storage/BKG_gbasf2/Kasen_syst/SIGNAL_analysis/validation_v005/final_output_root_after_MVA_Application_after_cut/B02Kstar0nunu";
 
    // for PID
    const char* KID_uncorrelated_info = "";
    const char* PID_uncorrelated_info = "";
    /* ====================================== */
