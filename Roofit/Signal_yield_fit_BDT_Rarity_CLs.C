...
//    printf("total multiplicative factor %lf\n", total_uncertainty_mul);
    ...
    // pdfs
    w->factory("EXPR::bkg('(1-Rarity)*exp(Rarity*a+Rarity*Rarity*b)',Rarity,a[-1.883, -3.0, 0.0],b[1.09])");
    ...
    mc.SetNuisanceParameters(RooArgSet(*w->var("a"), *w->var("b"), *w->var("alpha"), *w->var("beta"), *w->var("bkg_yield")));
