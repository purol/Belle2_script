...
double LetsFill_ri(const char* dirname, std::string SampleName, TH2D* hist) {
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        tree_upsilon->SetBranchAddress("MVA_BB", &temp_FBDT);
        tree_Btag->SetBranchAddress("Btag_extraInfo_SignalProbability", &temp_SignalProbability);
...
double LetsFill_ri(const char* dirname, std::string SampleName, const char* included_string, TH2D* hist) {
...
void Get2DpvalueFBDT() {
    ...
    double Nevt_B2Xsnunu = LetsFill_ri(Xsununu_dirname, "B2Xsnunu", "B2Xsnunu", signal_hist);
    double Nevt_B02K0nunu = LetsFill_ri(K0nunu_dirname, "B02K0nunu", "B02K0nunu", signal_hist);
    double Nevt_B02Kstar0nunu = LetsFill_ri(K0starnunu_dirname, "B02Kstar0nunu", "B02Kstar0nunu", signal_hist);
    double Nevt_B02Xsnunu = LetsFill_ri(Xsdnunu_dirname, "B02Xsnunu", "B02Xsnunu", signal_hist);

    double Nevt_CHG = LetsFill_ri(CHG_dirname, "CHG", bkg_hist);
    double Nevt_MIX = LetsFill_ri(MIX_dirname, "MIX", bkg_hist);
    double Nevt_UUBAR = LetsFill_ri(UUBAR_dirname, "UUBAR", bkg_hist);
    double Nevt_DDBAR = LetsFill_ri(DDBAR_dirname, "DDBAR", bkg_hist);
