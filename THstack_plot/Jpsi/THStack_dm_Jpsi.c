...
THStack* Stack = new THStack("thstack", ";dM [GeV];Arbitrary unit");
TH1F* SIGNAL_hist = new TH1F("signal", ";dM [GeV];Arbitrary unit", 100, -0.05, 0.05);
TH1F* CHG_hist = new TH1F("charge", ";E_{ecl} [GeV];Arbitrary unit", 100, -0.05, 0.05);
TH1F* MIX_hist = new TH1F("mix", ";E_{ecl} [GeV];Arbitrary unit", 100, -0.05, 0.05);
TH1F* UUBAR_hist = new TH1F("uubar", ";E_{ecl} [GeV];Arbitrary unit", 100, -0.05, 0.05);
TH1F* DDBAR_hist = new TH1F("ddbar", ";E_{ecl} [GeV];Arbitrary unit", 100, -0.05, 0.05);
TH1F* SSBAR_hist = new TH1F("ssbar", ";E_{ecl} [GeV];Arbitrary unit", 100, -0.05, 0.05);
TH1F* CHARM_hist = new TH1F("ccbar", ";E_{ecl} [GeV];Arbitrary unit", 100, -0.05, 0.05);
