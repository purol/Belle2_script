...
TH1F* SIGNAL_hist = new TH1F("SIGNAL_hist", ";#theta_{missing};",21, 0, 7);
TH1F* UUBAR_hist = new TH1F("UUBAR_hist", ";#theta_{missing};", 21, 0, 7);
TH1F* DDBAR_hist = new TH1F("DDBAR_hist", ";#theta_{missing};", 21, 0, 7);
TH1F* SSBAR_hist = new TH1F("SSBAR_hist", ";#theta_{missing};", 21, 0, 7);
TH1F* CHARM_hist = new TH1F("CHARM_hist", ";#theta_{missing};", 21, 0, 7);
...
void temp_THStack(){
    ...
    const char* SIGNAL_dirname = "/home/jwpark/storage/SIGNAL/Eecl3_test_withchi/before_Eecl_cut";
    const char* UUBAR_dirname = "/home/jwpark/storage/BKG_gbasf2/BKG_total/UUBAR_analysis/Eecl3_test_withchi/before_Eecl_cut";
    const char* DDBAR_dirname = "/home/jwpark/storage/BKG_gbasf2/BKG_total/DDBAR_analysis/Eecl3_test_withchi_exactly_half/before_Eecl_cut";
    const char* SSBAR_dirname = "/home/jwpark/storage/BKG_gbasf2/BKG_total/SSBAR_analysis/Eecl3_test_withchi_exactly_half/before_Eecl_cut";
    const char* CHARM_dirname = "/home/jwpark/storage/BKG_gbasf2/BKG_total/CHARM_analysis/Eecl3_test_withchi/before_Eecl_cut";
...
TH1F* CHARM_hist = new TH1F("CHARM_hist", ";E_{ecl} [GeV];arbitrary unit", 21, 0, 7);
...
void temp_THStack_Eecl() {

    const char* SIGNAL_dirname = "/home/jwpark/storage/SIGNAL_Aqua/test_v000/before_Eecl_cut";
    const char* CHG_dirname = "/home/jwpark/storage/BKG_gbasf2/Aqua/CHG_analysis/test_v000/before_Eecl_cut";
    const char* MIX_dirname = "/home/jwpark/storage/BKG_gbasf2/Aqua/MIX_analysis/test_v000/before_Eecl_cut";
    const char* UUBAR_dirname = "/home/jwpark/storage/BKG_gbasf2/Aqua/UUBAR_analysis/test_v000/before_Eecl_cut";
    const char* DDBAR_dirname = "/home/jwpark/storage/BKG_gbasf2/Aqua/DDBAR_analysis/test_v000/before_Eecl_cut";
    const char* SSBAR_dirname = "/home/jwpark/storage/BKG_gbasf2/Aqua/SSBAR_analysis/test_v000/before_Eecl_cut";
    const char* CHARM_dirname = "/home/jwpark/storage/BKG_gbasf2/Aqua/CHARM_analysis/test_v000/before_Eecl_cut";
