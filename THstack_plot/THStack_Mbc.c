...
TH1D* SIGNAL_hist = new TH1D("signal #times 5000", ";M_{bc}^{tag} [GeV];number of candidates", 100, 5.24, 5.3);
TH1D* CHG_hist = new TH1D("charged", ";M_{bc}^{tag} [GeV];number of candidates", 100, 5.24, 5.3);
TH1D* MIX_hist = new TH1D("mixed", ";M_{bc}^{tag} [GeV];number of candidates", 100, 5.24, 5.3);
TH1D* UUBAR_hist = new TH1D("u#bar{u}", ";M_{bc}^{tag} [GeV];number of candidates", 100, 5.24, 5.3);
TH1D* DDBAR_hist = new TH1D("d#bar{d}", ";M_{bc}^{tag} [GeV];number of candidates", 100, 5.24, 5.3);
TH1D* SSBAR_hist = new TH1D("s#bar{s}", ";M_{bc}^{tag} [GeV];number of candidates", 100, 5.24, 5.3);
TH1D* CHARM_hist = new TH1D("c#bar{c}", ";M_{bc}^{tag} [GeV];number of candidates", 100, 5.24, 5.3);
...
void THStack_Mbc() {
    ...
    const char* Knunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Mbc_cut";
    const char* Kstarnunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Mbc_cut";
    const char* Xsununu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Mbc_cut";
    const char* K0nunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Mbc_cut";
    const char* K0starnunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Mbc_cut";
    const char* Xsdnunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Mbc_cut";
    const char* CHG_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/CHG_analysis/test_v000/before_Mbc_cut";
    const char* MIX_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/MIX_analysis/test_v000/before_Mbc_cut";
    const char* UUBAR_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/UUBAR_analysis/test_v000/before_before_Mbc_cut";
    const char* DDBAR_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/DDBAR_analysis/test_v000/before_Mbc_cut";
    const char* SSBAR_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SSBAR_analysis/test_v000/before_Mbc_cut";
    const char* CHARM_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/CHARM_analysis/test_v000/before_Mbc_cut";
