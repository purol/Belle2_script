...
TH1F* SIGNAL_hist = new TH1F("signal #times 3000", ";D^{0} candidate mass [GeV];number of candidates", 70, 1.5, 2.0);
TH1F* CHG_hist = new TH1F("charged", ";D^{0} candidate mass [GeV];number of candidates", 70, 1.5, 2.0);
TH1F* MIX_hist = new TH1F("mixed", ";D^{0} candidate mass [GeV];number of candidates", 70, 1.5, 2.0);
TH1F* UUBAR_hist = new TH1F("u#bar{u}", ";D^{0} candidate mass [GeV];number of candidates", 70, 1.5, 2.0);
TH1F* DDBAR_hist = new TH1F("d#bar{d}", ";D^{0} candidate mass [GeV];number of candidates", 70, 1.5, 2.0);
TH1F* SSBAR_hist = new TH1F("s#bar{s}", ";D^{0} candidate mass [GeV];number of candidates", 70, 1.5, 2.0);
TH1F* CHARM_hist = new TH1F("c#bar{c}", ";D^{0} candidate mass [GeV];number of candidates", 70, 1.5, 2.0);
