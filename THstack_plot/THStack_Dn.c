...
THStack* Stack = new THStack("thstack", ";D^{0} candidate mass [GeV];arbitrary unit");
TH1F* SIGNAL_hist = new TH1F("SIGNAL_hist", ";D^{0} candidate mass [GeV];arbitrary unit", 70, 1.5, 2.0);
TH1F* CHG_hist = new TH1F("CHG_hist", ";D^{0} candidate mass [GeV];arbitrary unit", 70, 1.5, 2.0);
TH1F* MIX_hist = new TH1F("MIX_hist", ";D^{0} candidate mass [GeV];arbitrary unit", 70, 1.5, 2.0);
TH1F* UUBAR_hist = new TH1F("UUBAR_hist", ";D^{0} candidate mass [GeV];arbitrary unit", 70, 1.5, 2.0);
TH1F* DDBAR_hist = new TH1F("DDBAR_hist", ";D^{0} candidate mass [GeV];arbitrary unit", 70, 1.5, 2.0);
TH1F* SSBAR_hist = new TH1F("SSBAR_hist", ";D^{0} candidate mass [GeV];arbitrary unit", 70, 1.5, 2.0);
TH1F* CHARM_hist = new TH1F("CHARM_hist", ";D^{0} candidate mass [GeV];arbitrary unit", 70, 1.5, 2.0);
