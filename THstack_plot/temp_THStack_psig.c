...
TH1F* SIGNAL_hist = new TH1F("SIGNAL_hist", ";#theta_{missing};",100, 0, 3);
TH1F* UUBAR_hist = new TH1F("UUBAR_hist", ";#theta_{missing};", 100, 0, 3);
TH1F* DDBAR_hist = new TH1F("DDBAR_hist", ";#theta_{missing};", 100, 0, 3);
TH1F* SSBAR_hist = new TH1F("SSBAR_hist", ";#theta_{missing};", 100, 0, 3);
TH1F* CHARM_hist = new TH1F("CHARM_hist", ";#theta_{missing};", 100, 0, 3);
...
void temp_THStack(){
    ...
    const char* SIGNAL_dirname = "/home/jwpark/storage/SIGNAL/Eecl3_test_withchi/before_momentum_of_signal_side";
    const char* UUBAR_dirname = "/home/jwpark/storage/BKG_gbasf2/BKG_total/UUBAR_analysis/Eecl3_test_withchi/before_momentum_of_signal_side";
    const char* DDBAR_dirname = "/home/jwpark/storage/BKG_gbasf2/BKG_total/DDBAR_analysis/Eecl3_test_withchi_exactly_half/before_momentum_of_signal_side";
    const char* SSBAR_dirname = "/home/jwpark/storage/BKG_gbasf2/BKG_total/SSBAR_analysis/Eecl3_test_withchi_exactly_half/before_momentum_of_signal_side";
    const char* CHARM_dirname = "/home/jwpark/storage/BKG_gbasf2/BKG_total/CHARM_analysis/Eecl3_test_withchi/before_momentum_of_signal_side";
