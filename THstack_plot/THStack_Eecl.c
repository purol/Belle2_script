...
THStack* Stack = new THStack("thstack", ";E_{ecl} [GeV];number of candidates");
TH1D* SIGNAL_hist = new TH1D("signal #times 10000", ";E_{ecl} [GeV];number of candidates", 100, 0, 5);
TH1D* CHG_hist = new TH1D("charged", ";E_{ecl} [GeV];number of candidates", 100, 0, 5);
TH1D* MIX_hist = new TH1D("mixed", ";E_{ecl} [GeV];number of candidates", 100, 0, 5);
TH1D* UUBAR_hist = new TH1D("u#bar{u}", ";E_{ecl} [GeV];number of candidates", 100, 0, 5);
TH1D* DDBAR_hist = new TH1D("d#bar{d}", ";E_{ecl} [GeV];number of candidates", 100, 0, 5);
TH1D* SSBAR_hist = new TH1D("s#bar{s}", ";E_{ecl} [GeV];number of candidates", 100, 0, 5);
TH1D* CHARM_hist = new TH1D("c#bar{c}", ";E_{ecl} [GeV];number of candidates", 100, 0, 5);
...
void THStack_Eecl() {
    ...
    const char* Knunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Eecl_cut";
    const char* Kstarnunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Eecl_cut";
    const char* Xsununu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Eecl_cut";
    const char* K0nunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Eecl_cut";
    const char* K0starnunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Eecl_cut";
    const char* Xsdnunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_Eecl_cut";
    const char* CHG_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/CHG_analysis/test_v000/before_Eecl_cut";
    const char* MIX_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/MIX_analysis/test_v000/before_Eecl_cut";
    const char* UUBAR_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/UUBAR_analysis/test_v000/before_before_Eecl_cut";
    const char* DDBAR_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/DDBAR_analysis/test_v000/before_Eecl_cut";
    const char* SSBAR_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SSBAR_analysis/test_v000/before_Eecl_cut";
    const char* CHARM_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/CHARM_analysis/test_v000/before_Eecl_cut";
