...
TH1F* CHG_hist = new TH1F("UUBAR_hist", ";number of remaining tracks;arbitrary unit", 7, -0.5, 6.5);
TH1F* MIX_hist = new TH1F("DDBAR_hist", ";number of remaining tracks;arbitrary unit", 7, -0.5, 6.5);
