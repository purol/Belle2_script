...
double GetNominalPDFs(const char* dirname, const char* included_string, TH1D* histMX1, TH1D* histMX2, TH1D* histMX3, const char* type, const char* sample, Corrector_Fragmentation::SystType systtype, double weight_var = 1.0, std::string CorrectionType = "otherwise") { // get nominal PDF with appropriate correction
    /*
...
void ReadXsTransitionPDF()
{
    ...
    // nominal PDFs
    TH1D* Xsu_nominal_MX1 = new TH1D("Xsu_nominal_MX1", "Xsu_nominal_MX1", RarityBins, BinMIN, BinMAX);
    TH1D* Xsd_nominal_MX1 = new TH1D("Xsd_nominal_MX1", "Xsd_nominal_MX1", RarityBins, BinMIN, BinMAX);
    TH1D* Xsu_nominal_MX2 = new TH1D("Xsu_nominal_MX2", "Xsu_nominal_MX2", RarityBins, BinMIN, BinMAX);
    TH1D* Xsd_nominal_MX2 = new TH1D("Xsd_nominal_MX2", "Xsd_nominal_MX2", RarityBins, BinMIN, BinMAX);
    TH1D* Xsu_nominal_MX3 = new TH1D("Xsu_nominal_MX3", "Xsu_nominal_MX3", RarityBins, BinMIN, BinMAX);
    TH1D* Xsd_nominal_MX3 = new TH1D("Xsd_nominal_MX3", "Xsd_nominal_MX3", RarityBins, BinMIN, BinMAX);

    // transition
    TH1D* Xsu_transition_p_MX1 = new TH1D("Xsu_transition_p_MX1", "Xsu_transition_p_MX1", RarityBins, BinMIN, BinMAX);
    TH1D* Xsu_transition_m_MX1 = new TH1D("Xsu_transition_m_MX1", "Xsu_transition_m_MX1", RarityBins, BinMIN, BinMAX);
    TH1D* Xsd_transition_p_MX1 = new TH1D("Xsd_transition_p_MX1", "Xsd_transition_p_MX1", RarityBins, BinMIN, BinMAX);
    TH1D* Xsd_transition_m_MX1 = new TH1D("Xsd_transition_m_MX1", "Xsd_transition_m_MX1", RarityBins, BinMIN, BinMAX);
    TH1D* Xsu_transition_p_MX2 = new TH1D("Xsu_transition_p_MX2", "Xsu_transition_p_MX2", RarityBins, BinMIN, BinMAX);
    TH1D* Xsu_transition_m_MX2 = new TH1D("Xsu_transition_m_MX2", "Xsu_transition_m_MX2", RarityBins, BinMIN, BinMAX);
    TH1D* Xsd_transition_p_MX2 = new TH1D("Xsd_transition_p_MX2", "Xsd_transition_p_MX2", RarityBins, BinMIN, BinMAX);
    TH1D* Xsd_transition_m_MX2 = new TH1D("Xsd_transition_m_MX2", "Xsd_transition_m_MX2", RarityBins, BinMIN, BinMAX);
    TH1D* Xsu_transition_p_MX3 = new TH1D("Xsu_transition_p_MX3", "Xsu_transition_p_MX3", RarityBins, BinMIN, BinMAX);
    TH1D* Xsu_transition_m_MX3 = new TH1D("Xsu_transition_m_MX3", "Xsu_transition_m_MX3", RarityBins, BinMIN, BinMAX);
    TH1D* Xsd_transition_p_MX3 = new TH1D("Xsd_transition_p_MX3", "Xsd_transition_p_MX3", RarityBins, BinMIN, BinMAX);
    TH1D* Xsd_transition_m_MX3 = new TH1D("Xsd_transition_m_MX3", "Xsd_transition_m_MX3", RarityBins, BinMIN, BinMAX);
    /* ====================================== */
    ...
    // Get PDFs
    // get nominal pdfs
    GetNominalPDFs(MC_dirname_SIGNAL, "B2Xsnunu", Xsu_nominal_MX1, Xsu_nominal_MX2, Xsu_nominal_MX3, "Bplus", "SIGNAL", Corrector_Fragmentation::SystType::Nominal, Scale_Xsu_nonresonant_test, "B2Xsnunu");
    GetNominalPDFs(MC_dirname_SIGNAL, "B02Xsnunu", Xsd_nominal_MX1, Xsd_nominal_MX2, Xsd_nominal_MX3, "Bzero", "SIGNAL", Corrector_Fragmentation::SystType::Nominal, Scale_Xsd_nonresonant_test, "B02Xsnunu");

    // transition
    GetNominalPDFs(MC_dirname_syst, "B2Xsnunu_Htransition", Xsu_transition_p_MX1, Xsu_transition_p_MX2, Xsu_transition_p_MX3, "Bplus", "SIGNAL", Corrector_Fragmentation::SystType::Htransition, Scale_Xsu_nonresonant_syst, "B2Xsnunu");
    GetNominalPDFs(MC_dirname_syst, "B02Xsnunu_Htransition", Xsd_transition_p_MX1, Xsd_transition_p_MX2, Xsd_transition_p_MX3, "Bzero", "SIGNAL", Corrector_Fragmentation::SystType::Htransition, Scale_Xsd_nonresonant_syst, "B02Xsnunu");

    GetNominalPDFs(MC_dirname_syst, "B2Xsnunu_Ltransition", Xsu_transition_m_MX1, Xsu_transition_m_MX2, Xsu_transition_m_MX3, "Bplus", "SIGNAL", Corrector_Fragmentation::SystType::Ltransition, Scale_Xsu_nonresonant_syst, "B2Xsnunu");
    GetNominalPDFs(MC_dirname_syst, "B02Xsnunu_Ltransition", Xsd_transition_m_MX1, Xsd_transition_m_MX2, Xsd_transition_m_MX3, "Bzero", "SIGNAL", Corrector_Fragmentation::SystType::Ltransition, Scale_Xsd_nonresonant_syst, "B02Xsnunu");
    /* ====================================== */
    ...
    fp = fopen("Xsu_Htransition_MX1_weight.txt", "w");
    fprintf(fp, "%d\n", RarityBins);
    for (int i = 0; i < RarityBins; i++) { // Xsu up
        double correction_factor = Xsu_transition_p_MX1->GetBinContent(i + 1) / Xsu_nominal_MX1->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);
    fp = fopen("Xsu_Htransition_MX2_weight.txt", "w");
    for (int i = 0; i < RarityBins; i++) { // Xsu up
        double correction_factor = Xsu_transition_p_MX2->GetBinContent(i + 1) / Xsu_nominal_MX2->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);
    fp = fopen("Xsu_Htransition_MX3_weight.txt", "w");
    for (int i = 0; i < RarityBins; i++) { // Xsu up
        double correction_factor = Xsu_transition_p_MX3->GetBinContent(i + 1) / Xsu_nominal_MX3->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);

    fp = fopen("Xsu_Ltransition_MX1_weight.txt", "w");
    fprintf(fp, "%d\n", RarityBins);
    for (int i = 0; i < RarityBins; i++) { // Xsu down
        double correction_factor = Xsu_transition_m_MX1->GetBinContent(i + 1) / Xsu_nominal_MX1->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);
    fp = fopen("Xsu_Ltransition_MX2_weight.txt", "w");
    for (int i = 0; i < RarityBins; i++) { // Xsu down
        double correction_factor = Xsu_transition_m_MX2->GetBinContent(i + 1) / Xsu_nominal_MX2->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);
    fp = fopen("Xsu_Ltransition_MX3_weight.txt", "w");
    for (int i = 0; i < RarityBins; i++) { // Xsu down
        double correction_factor = Xsu_transition_m_MX3->GetBinContent(i + 1) / Xsu_nominal_MX3->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);

    fp = fopen("Xsd_Htransition_MX1_weight.txt", "w");
    fprintf(fp, "%d\n", RarityBins);
    for (int i = 0; i < RarityBins; i++) { // Xsd up
        double correction_factor = Xsd_transition_p_MX1->GetBinContent(i + 1) / Xsd_nominal_MX1->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);
    fp = fopen("Xsd_Htransition_MX2_weight.txt", "w");
    for (int i = 0; i < RarityBins; i++) { // Xsd up
        double correction_factor = Xsd_transition_p_MX2->GetBinContent(i + 1) / Xsd_nominal_MX2->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);
    fp = fopen("Xsd_Htransition_MX3_weight.txt", "w");
    for (int i = 0; i < RarityBins; i++) { // Xsd up
        double correction_factor = Xsd_transition_p_MX3->GetBinContent(i + 1) / Xsd_nominal_MX3->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);

    fp = fopen("Xsd_Ltransition_MX1_weight.txt", "w");
    fprintf(fp, "%d\n", RarityBins);
    for (int i = 0; i < RarityBins; i++) { // Xsd down
        double correction_factor = Xsd_transition_m_MX1->GetBinContent(i + 1) / Xsd_nominal_MX1->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);
    fp = fopen("Xsd_Ltransition_MX2_weight.txt", "w");
    for (int i = 0; i < RarityBins; i++) { // Xsd down
        double correction_factor = Xsd_transition_m_MX2->GetBinContent(i + 1) / Xsd_nominal_MX2->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);
    fp = fopen("Xsd_Ltransition_MX3_weight.txt", "w");
    for (int i = 0; i < RarityBins; i++) { // Xsd down
        double correction_factor = Xsd_transition_m_MX3->GetBinContent(i + 1) / Xsd_nominal_MX3->GetBinContent(i + 1);
        fprintf(fp, "%lf\n", correction_factor);
    }
    fclose(fp);
    /* ====================================== */

    delete Xsu_nominal_MX1;
    delete Xsd_nominal_MX1;
    delete Xsu_nominal_MX2;
    delete Xsd_nominal_MX2;
    delete Xsu_nominal_MX3;
    delete Xsd_nominal_MX3;

    delete Xsu_transition_p_MX1;
    delete Xsu_transition_m_MX1;
    delete Xsd_transition_p_MX1;
    delete Xsd_transition_m_MX1;
    delete Xsu_transition_p_MX2;
    delete Xsu_transition_m_MX2;
    delete Xsd_transition_p_MX2;
    delete Xsd_transition_m_MX2;
    delete Xsu_transition_p_MX3;
    delete Xsu_transition_m_MX3;
    delete Xsd_transition_p_MX3;
    delete Xsd_transition_m_MX3;
}
