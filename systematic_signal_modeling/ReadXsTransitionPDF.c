...
void ReadXsTransitionPDF()
{
    ...
    // Get PDFs
    // get nominal pdfs
    GetNominalPDFs(MC_dirname_SIGNAL, "B2Xsnunu", Xsu_nominal, "Bplus", "SIGNAL", Scale_Xsu_nonresonant_test, "otherwise");
    GetNominalPDFs(MC_dirname_SIGNAL, "B02Xsnunu", Xsd_nominal, "Bzero", "SIGNAL", Scale_Xsd_nonresonant_test, "otherwise");

    // transition
    GetNominalPDFs(MC_dirname_syst, "B2Xsnunu_Htransition", Xsu_transition_p, "Bplus", "SIGNAL", Scale_Xsu_nonresonant_syst, "otherwise");
    GetNominalPDFs(MC_dirname_syst, "B02Xsnunu_Htransition", Xsd_transition_p, "Bzero", "SIGNAL", Scale_Xsd_nonresonant_syst, "otherwise");

    GetNominalPDFs(MC_dirname_syst, "B2Xsnunu_Ltransition", Xsu_transition_m, "Bplus", "SIGNAL", Scale_Xsu_nonresonant_syst, "otherwise");
    GetNominalPDFs(MC_dirname_syst, "B02Xsnunu_Ltransition", Xsd_transition_m, "Bzero", "SIGNAL", Scale_Xsd_nonresonant_syst, "otherwise");
    /* ====================================== */
