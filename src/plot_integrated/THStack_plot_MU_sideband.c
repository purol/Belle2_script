...
void THStack_plot_MU_sideband() {
    ...
    const char* Sideband_MC_CHG_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_MU/CHG_analysis/validation_v004/final_output";
    const char* Sideband_MC_MIX_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_MU/MIX_analysis/validation_v004/final_output";
    const char* Sideband_MC_UUBAR_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_MU/UUBAR_analysis/validation_v004/final_output";
    const char* Sideband_MC_DDBAR_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_MU/DDBAR_analysis/validation_v004/final_output";
    const char* Sideband_MC_SSBAR_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_MU/SSBAR_analysis/validation_v004/final_output";
    const char* Sideband_MC_CHARM_validation_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_MC_MU/CHARM_analysis/validation_v004/final_output";

    const char* Sideband_data_dirname = "/home/belle2/junewoo/storage_ghi/Analysis/SatoriRD_LS_data_MU/SIGNAL_analysis/validation_v004/final_output";
    ...
    LetsFillMC_MUSide(Sideband_MC_CHG_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "CHG");
    LetsFillMC_MUSide(Sideband_MC_MIX_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "MIX");
    LetsFillMC_MUSide(Sideband_MC_UUBAR_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "UUBAR");
    LetsFillMC_MUSide(Sideband_MC_DDBAR_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "DDBAR");
    LetsFillMC_MUSide(Sideband_MC_SSBAR_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "SSBAR");
    LetsFillMC_MUSide(Sideband_MC_CHARM_validation_dirname, variable_names, branch_names, Sideband_MC_values, &Sideband_MC_numbering, &weights, "CHARM");
    ...
    for (int k = 0; k < (int)variable_names.size(); k++) { // draw
        ...
        c_temp->SaveAs((variable_names.at(k) + "_E_sideband.png").c_str());
