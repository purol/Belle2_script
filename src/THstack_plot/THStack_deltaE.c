...
THStack* Stack = new THStack("thstack", ";#Delta E^{tag} [GeV];number of candidates");
TH1D* SIGNAL_hist = new TH1D("signal #times 2000", ";#Delta E^{tag} [GeV];number of candidates", 100, -0.3, 0.3);
TH1D* CHG_hist = new TH1D("charged", ";#Delta E^{tag} [GeV];number of candidates", 100, -0.3, 0.3);
TH1D* MIX_hist = new TH1D("mixed", ";#Delta E^{tag} [GeV];number of candidates", 100, -0.3, 0.3);
TH1D* UUBAR_hist = new TH1D("u#bar{u}", ";#Delta E^{tag} [GeV];number of candidates", 100, -0.3, 0.3);
TH1D* DDBAR_hist = new TH1D("d#bar{d}", ";#Delta E^{tag} [GeV];number of candidates", 100, -0.3, 0.3);
TH1D* SSBAR_hist = new TH1D("s#bar{s}", ";#Delta E^{tag} [GeV];number of candidates", 100, -0.3, 0.3);
TH1D* CHARM_hist = new TH1D("c#bar{c}", ";#Delta E^{tag} [GeV];number of candidates", 100, -0.3, 0.3);
...
void THStack_deltaE() {
    ...
    const char* Knunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_delE_cut";
    const char* Kstarnunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_delE_cut";
    const char* Xsununu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_delE_cut";
    const char* K0nunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_delE_cut";
    const char* K0starnunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_delE_cut";
    const char* Xsdnunu_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SIGNAL_analysis/test_v000/before_delE_cut";
    const char* CHG_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/CHG_analysis/test_v000/before_delE_cut";
    const char* MIX_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/MIX_analysis/test_v000/before_delE_cut";
    const char* UUBAR_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/UUBAR_analysis/test_v000/before_delE_cut";
    const char* DDBAR_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/DDBAR_analysis/test_v000/before_delE_cut";
    const char* SSBAR_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/SSBAR_analysis/test_v000/before_delE_cut";
    const char* CHARM_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/SatoriRD/CHARM_analysis/test_v000/before_delE_cut";
    ...
    */
    ...
    TLine* line = new TLine(0.2, 0, 0.2, ymax);
    line->SetLineColor(kRed);
    line->SetLineStyle(5);
    line->SetLineWidth(3);
    line->Draw();
    TLine* line2 = new TLine(-0.2, 0, -0.2, ymax);
    line2->SetLineColor(kRed);
    line2->SetLineStyle(5);
    line2->SetLineWidth(3);
    line2->Draw();
    c_temp->SaveAs("Plot_deltaE.png");
