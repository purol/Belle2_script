...
void AddSample(HistFactory::Channel* channel, const char* fname, int MXs_bin, const double expmu, double qq_CAL, double qq_CAL_relativeuncer, double FBDT_CAL, double FBDT_CAL_relativeuncer, double bkg_norm_relativeuncer, double bkg_norm = 1.0) {
	...
	int NEntryNEWFEICAL = ReadNNEWFEICALEigenVector("./NEWFEICAL_selected.txt");
	...
	if (projection_NEWFEICAL == false) for (int i = 0; i < NEntryNEWFEICAL; i++) if (IsThereAnyChange(fname, "Signal_MXs1_nominal", ("Signal_MXs1_NEWFEICAL_correlated" + std::to_string(i) + "_m").c_str(), ("Signal_MXs1_NEWFEICAL_correlated" + std::to_string(i) + "_p").c_str())) sig_temp_MXs1.AddHistoSys(("NEWFEICAL" + std::to_string(i) + "_uncer").c_str(), ("Signal_MXs1_NEWFEICAL_correlated" + std::to_string(i) + "_m").c_str(), fname, "", ("Signal_MXs1_NEWFEICAL_correlated" + std::to_string(i) + "_p").c_str(), fname, "");
	...
	if(Inf_MCstat == false) sig_temp_MXs1.ActivateStatError("Signal_MXs1_all_uncorrelated_MC_stat", fname, "");
	...
	if (projection_NEWFEICAL == false) for (int i = 0; i < NEntryNEWFEICAL; i++) if (IsThereAnyChange(fname, "Signal_MXs2_nominal", ("Signal_MXs2_NEWFEICAL_correlated" + std::to_string(i) + "_m").c_str(), ("Signal_MXs2_NEWFEICAL_correlated" + std::to_string(i) + "_p").c_str())) sig_temp_MXs2.AddHistoSys(("NEWFEICAL" + std::to_string(i) + "_uncer").c_str(), ("Signal_MXs2_NEWFEICAL_correlated" + std::to_string(i) + "_m").c_str(), fname, "", ("Signal_MXs2_NEWFEICAL_correlated" + std::to_string(i) + "_p").c_str(), fname, "");
	...
	if (Inf_MCstat == false) sig_temp_MXs2.ActivateStatError("Signal_MXs2_all_uncorrelated_MC_stat", fname, "");
	...
	if (projection_NEWFEICAL == false) for (int i = 0; i < NEntryNEWFEICAL; i++) if (IsThereAnyChange(fname, "Signal_MXs3_nominal", ("Signal_MXs3_NEWFEICAL_correlated" + std::to_string(i) + "_m").c_str(), ("Signal_MXs3_NEWFEICAL_correlated" + std::to_string(i) + "_p").c_str())) sig_temp_MXs3.AddHistoSys(("NEWFEICAL" + std::to_string(i) + "_uncer").c_str(), ("Signal_MXs3_NEWFEICAL_correlated" + std::to_string(i) + "_m").c_str(), fname, "", ("Signal_MXs3_NEWFEICAL_correlated" + std::to_string(i) + "_p").c_str(), fname, "");
	...
	if (Inf_MCstat == false) sig_temp_MXs3.ActivateStatError("Signal_MXs3_all_uncorrelated_MC_stat", fname, "");
	...
	if (Inf_MCstat == false) CHG_temp.ActivateStatError("CHG_all_uncorrelated_MC_stat", fname, "");
	...
	if (Inf_MCstat == false) MIX_temp.ActivateStatError("MIX_all_uncorrelated_MC_stat", fname, "");
	...
	if (projection_offresonance == false) if (Inf_MCstat == false) UUBAR_temp.ActivateStatError("UUBAR_all_uncorrelated_MC_stat", fname, "");
	...
	if (projection_offresonance == false) if (Inf_MCstat == false) DDBAR_temp.ActivateStatError("DDBAR_all_uncorrelated_MC_stat", fname, "");
	...
	if (projection_offresonance == false) if (Inf_MCstat == false) SSBAR_temp.ActivateStatError("SSBAR_all_uncorrelated_MC_stat", fname, "");
	...
	if (projection_offresonance == false) if (Inf_MCstat == false) CHARM_temp.ActivateStatError("CHARM_all_uncorrelated_MC_stat", fname, "");
...
int WorkSpace() {
	...
	// get MC
	if(projection_bkgnorm == false) AddSample(&channel_MXs1, fname_MXs1, 1, expmu, 1.1991, 0.1072, 1.0226, 0.0356, 0.2);
	else AddSample(&channel_MXs1, fname_MXs1, 1, expmu, 1.1991, 0.1072, 1.0226, 0.0356, error_values[0], central_values[0]);
	if (KnunuOnly) {
		AddEmptySample(&channel_MXs2, 2);
		AddEmptySample(&channel_MXs3, 3);
	}
	else {
		if (projection_bkgnorm == false) {
			...
			AddSample(&channel_MXs2, fname_MXs2, 2, expmu, 0.7580, 0.2375, 1.0647, 0.0787, error_values[1], central_values[1]);
			AddSample(&channel_MXs3, fname_MXs3, 3, expmu, 0.7121, 0.1352, 0.9457, 0.1515, error_values[2], central_values[2]);
		}
	}
