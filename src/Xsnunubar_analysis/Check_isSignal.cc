...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        loader.CountBtag(names.at(i), { 1, 2 }, argv[4], argv[5], argv[6], true);

        loader.Cut(Loader::Btag, 11, Loader::larger_than, 0.5); // Btag_isSignal == 1
        loader.Cut(Loader::Btag, 11, Loader::smaller_than, 1.5); // Btag_isSignal == 1

        loader.PrintInformation(std::string("========== isSignal Btag == 1 =========="), names.at(i), argv[4], argv[5], argv[6], true);
        loader.CountBtag(names.at(i), { 1, 2 }, argv[4], argv[5], argv[6], true);
