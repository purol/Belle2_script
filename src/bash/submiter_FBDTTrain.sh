...
mkdir -p /home/belle2/junewoo/storage_b1/bsub/Analysis/GridSearch/log/
mkdir -p /home/belle2/junewoo/storage_b1/bsub/Analysis/GridSearch/err/
mkdir -p /home/belle2/junewoo/storage_b1/bsub/Analysis/GridSearch/out/
...
do
  for depth in 2 3 4
  do
    for shrinkage in 0.05 0.1 0.15 0.2
    do
      for subsample in 0.3 0.4 0.5 0.6 0.7
      do
        for binning in 5 6 7 8 9
        do
          bsub -q l -o /home/belle2/junewoo/storage_b1/bsub/Analysis/GridSearch/log/${nTree}_${depth}_${shrinkage}_${subsample}_${binning}.log -e /home/belle2/junewoo/storage_b1/bsub/Analysis/GridSearch/err/${nTree}_${depth}_${shrinkage}_${subsample}_${binning}.err ./submit_FBDTTrain.sh "./bin/"${code} ${nTree} ${depth} ${shrinkage} ${subsample} ${binning} ${VerName} ${DirName} ${MCver}
        done
      done
    done
  done
...
code="FastBDTGridSearch_BDTc_off"
VerName="Kumoi"
DirName="v007"
MCver="MC15ri"
...
do
  ...
  do
    for shrinkage in 0.01 0.05 0.1 0.15 0.2
    do
