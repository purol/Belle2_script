...
void THStack_plot_comparison_signal() {
    ...
    const char* old_signal_validation_dirname = "/home/belle2/junewoo/storage_b1/bsub/Analysis/KumoiRD/SIGNAL_analysis/validation_v008/final_output_root_after_MVA_Application/";
