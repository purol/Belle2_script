...
# KS0
file_KS0_cov_all = "KS0_corr_all.txt"
file_KS0_cov_partial = "KS0_corr_partial.txt"

KS0_cov_all = np.loadtxt(file_KS0_cov_all, dtype=float)
KS0_cov_partial = np.loadtxt(file_KS0_cov_partial, dtype=float)

ar = np.array(KS0_cov_all)
...
#plt.show()
plt.savefig('KS0_corr_all.png')

plt.clf()

ar_p = np.array(KS0_cov_partial)
...
#plt.show()
plt.savefig('KS0_corr_partial.png')
