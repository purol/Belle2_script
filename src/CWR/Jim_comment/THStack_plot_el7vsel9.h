...
Corrector_Multiplicity corrector_Multiplicity_el7("/home/belle2/junewoo/storage_b1/bsub/Analysis/MizuhashiRD_LS_MC_cside/Multiplicity_systematic/MizuhashiRD_v009/multiplicity_weight.txt");
Corrector_Multiplicity corrector_Multiplicity_el9("/home/belle2/junewoo/storage_ghi/Analysis/ByakurenRD_LS_MC_cside/Multiplicity_systematic/ByakurenRD_v009/multiplicity_weight.txt");
...
void LetsFill_ri(const char* dirname, std::vector<std::string> variable_names, std::vector<std::string> branch_names, std::vector<double> variable_values[Nvar_num], std::vector<int>* numberings, std::vector<double>* weights, std::string SampleName, std::string OS, std::string sample_type, double CAL, double CAL_qq_K, double CAL_qq_Kstar, double CAL_qq_Xs, const char* included_string) {
    /*
    SampleName for Knn
    CHG
    MIX
    ...
    */
    ...
    for (unsigned int i = 0; i < names.size(); i++) {
        ...
        for (unsigned int j = 0; j < tree_upsilon->GetEntries(); j++) { // Fill
            ...
            else if (SampleName == "MIX" && OS == "el7") {
                numberings->push_back(1);
                FEI_calibration_factor = corrector_FEI.GetFEICalFactor(Upsilon_ID, Btag_ID, MCTYPE);
                weight_ri = ObtainWeight(SampleName.c_str(), MCTYPE.c_str(), sample_type.c_str(), names.at(i));
            }
            else if (SampleName == "UUBAR" && OS == "el7") {
            ...
            else if (SampleName == "DDBAR" && OS == "el7") {
            ...
            else if (SampleName == "SSBAR" && OS == "el7") {
            ...
            else if (SampleName == "CHARM" && OS == "el7") {
            ...
            else if (SampleName == "CHG" && OS == "el9") {
                numberings->push_back(0 + IndexShift);
                FEI_calibration_factor = corrector_FEI.GetFEICalFactor(Upsilon_ID, Btag_ID, MCTYPE);
                weight_ri = ObtainWeight(SampleName.c_str(), MCTYPE.c_str(), sample_type.c_str(), names.at(i));
            }
            else if (SampleName == "MIX" && OS == "el9") {
                numberings->push_back(1 + IndexShift);
                FEI_calibration_factor = corrector_FEI.GetFEICalFactor(Upsilon_ID, Btag_ID, MCTYPE);
                weight_ri = ObtainWeight(SampleName.c_str(), MCTYPE.c_str(), sample_type.c_str(), names.at(i));
            }
            else if (SampleName == "UUBAR" && OS == "el9") {
            ...
            else if (SampleName == "DDBAR" && OS == "el9") {
            ...
            else if (SampleName == "SSBAR" && OS == "el9") {
            ...
            else if (SampleName == "CHARM" && OS == "el9") {
            ...
            double Correction_Knn = corrector_Knn.GetCorrectionFactorCancelOutObtainWeight(invM_Knn, invM_Kstarnn, invM_K0nn, invM_K0starnn, N_Knn, N_Kstarnn, N_K0nn, N_K0starnn, names.at(i), MCTYPE.c_str(), true);
            ...
            if (OS == "el7") Correction_multiplicity = corrector_Multiplicity_el7.GetCorrectionFactor(Ngamma_v200);
            else if (OS == "el9") Correction_multiplicity = corrector_Multiplicity_el9.GetCorrectionFactor(Ngamma_v200);
            ...
            weights->push_back(FEI_calibration_factor * CAL * weight_ri * Correction_pi0 * Correction_KID * Correction_PID * Correction_fake * Correction_KS0 * Correction_Knn * Correction_Xnn * Correction_multiplicity * Correction_KpKLKL * Correction_KSKLKL * Correction_KstarKLKL * Correction_XKLKL * Correction_BtoDtoXKL);
