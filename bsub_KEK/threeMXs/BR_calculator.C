...
void GetNominalNevt(const char* dirname, const char* included_string, TH1D* histMX1, TH1D* histMX2, TH1D* histMX3, const char* type, const char* sample, double Nevt_nominal[RarityBins * 3 * 3], double weight_var = 1.0, std::string CorrectionType = "otherwise") { // get nominal PDF with appropriate correction
    /*
...
void GetFlucNevt(const char* dirname, const char* included_string, TH1D* histMX1, TH1D* histMX2, TH1D* histMX3, const char* type, const char* sample, double Nevt_fluc[NToys][RarityBins * 3 * 3], int ToyNum, double weight_var = 1.0, std::string CorrectionType = "otherwise") { // get nominal PDF with appropriate correction
    /*
    CorrectionType for new form factors
    B2Knunu
    B02K0nunu
...
int main(int argc, char* argv[])
{
    ...
    // CHGMX1 CHGMX2 CHGMX3 MIXMX1 MIXMX2 MIXMX3 SIGNALMX1 SIGNALMX2 SIGNALMX3
    double Nevt_nominal[RarityBins * 3 * 3] = { 0.0 }; // CHG MIX SIGNAL
    double Nevt_fluc[NToys][RarityBins * 3 * 3] = { 0.0 }; // CHG MIX SIGNAL
    double Relative_Uncertainty[NToys][RarityBins * 3 * 3] = { 0.0 };
    double Covariance[RarityBins * 3 * 3][RarityBins * 3 * 3] = { 0.0 };
    ...
    for (int i = 0; i < NToys; i++) {
        ...
        GetFlucNevt(MC_dirname_SIGNAL, "B2Knunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bplus", "SIGNAL", Nevt_fluc, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Knunu"), "B2Knunu");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B2Kstarnunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bplus", "SIGNAL", Nevt_fluc, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Kstarnunu"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B2Xsnunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bplus", "SIGNAL", Nevt_fluc, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Xsnunu"), "B2Xsnunu");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02K0nunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bzero", "SIGNAL", Nevt_fluc, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02K0nunu"), "B02K0nunu");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02Kstar0nunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bzero", "SIGNAL", Nevt_fluc, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Kstar0nunu"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02Xsnunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bzero", "SIGNAL", Nevt_fluc, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Xsnunu"), "B02Xsnunu");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();

        GetFlucNevt(MC_dirname_CHG, "root", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bplus", "CHG", Nevt_fluc, i, ObtainWeight("CHG", MCTYPE, "validation", "CHG"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_MIX, "root", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bzero", "MIX", Nevt_fluc, i, ObtainWeight("MIX", MCTYPE, "validation", "MIX"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
    }
    ...
    for (int i = 0; i < NToys; i++) {
        for (int j = 0; j < RarityBins * 3 * 3; j++) {
