...
int main(int argc, char* argv[])
{
    ...
    double Nevt_fluc_pi0[NToys][RarityBins * 7 * 3] = { 0.0 }; // CHG MIX UUBAR DDBAR SSBAR CHARM SIGNAL
    double Relative_Uncertainty_pi0[NToys][RarityBins * 7 * 3] = { 0.0 };
    double Covariance_pi0[RarityBins * 7 * 3][RarityBins * 7 * 3] = { 0.0 };
    ...
    for (int i = 0; i < NToys; i++) {
        ...
        GetFlucNevt(MC_dirname_SIGNAL, "B2Knunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bplus", "SIGNAL", Nevt_fluc_pi0, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Knunu"), "B2Knunu");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B2Kstarnunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bplus", "SIGNAL", Nevt_fluc_pi0, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Kstarnunu"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B2Xsnunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bplus", "SIGNAL", Nevt_fluc_pi0, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B2Xsnunu"), "B2Xsnunu");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02K0nunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bzero", "SIGNAL", Nevt_fluc_pi0, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02K0nunu"), "B02K0nunu");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02Kstar0nunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bzero", "SIGNAL", Nevt_fluc_pi0, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Kstar0nunu"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02Xsnunu", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bzero", "SIGNAL", Nevt_fluc_pi0, i, ObtainWeight("SIGNAL", MCTYPE, "validation", "B02Xsnunu"), "B02Xsnunu");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();

        GetFlucNevt(MC_dirname_CHG, "root", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bplus", "CHG", Nevt_fluc_pi0, i, ObtainWeight("CHG", MCTYPE, "validation", "CHG"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_MIX, "root", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Bzero", "MIX", Nevt_fluc_pi0, i, ObtainWeight("MIX", MCTYPE, "validation", "MIX"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_UUBAR, "root", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Continuum", "UUBAR", Nevt_fluc_pi0, i, ObtainWeight("UUBAR", MCTYPE, "validation", "UUBAR"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_DDBAR, "root", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Continuum", "DDBAR", Nevt_fluc_pi0, i, ObtainWeight("DDBAR", MCTYPE, "validation", "DDBAR"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_SSBAR, "root", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Continuum", "SSBAR", Nevt_fluc_pi0, i, ObtainWeight("SSBAR", MCTYPE, "validation", "SSBAR"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
        GetFlucNevt(MC_dirname_CHARM, "root", temp_hist_MX1, temp_hist_MX2, temp_hist_MX3, "Continuum", "CHARM", Nevt_fluc_pi0, i, ObtainWeight("CHARM", MCTYPE, "validation", "CHARM"), "otherwise");
        temp_hist_MX1->Reset();
        temp_hist_MX2->Reset();
        temp_hist_MX3->Reset();
    }
