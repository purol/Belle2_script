...
int main(int argc, char* argv[])
{
    ...
    for (int i = 0; i < NToys; i++) {
        ...
        GetFlucNevt(MC_dirname_SIGNAL, "B2Knunu", temp_hist, "Bplus", "SIGNAL", Nevt_fluc_pi0, i, Scale_Kplus_test, "B2Knunu");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B2Kstarnunu", temp_hist, "Bplus", "SIGNAL", Nevt_fluc_pi0, i, Scale_Kplusstar_test, "otherwise");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B2Xsnunu", temp_hist, "Bplus", "SIGNAL", Nevt_fluc_pi0, i, Scale_Xsu_nonresonant_test, "otherwise");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02K0nunu", temp_hist, "Bzero", "SIGNAL", Nevt_fluc_pi0, i, Scale_K0_test, "B02K0nunu");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02Kstar0nunu", temp_hist, "Bzero", "SIGNAL", Nevt_fluc_pi0, i, Scale_K0star_test, "otherwise");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02Xsnunu", temp_hist, "Bzero", "SIGNAL", Nevt_fluc_pi0, i, Scale_Xsd_nonresonant_test, "otherwise");
        temp_hist->Reset();

        GetFlucNevt(MC_dirname_CHG, "root", temp_hist, "Bplus", "CHG", Nevt_fluc_pi0, i, Scale_CHG_test, "otherwise");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_MIX, "root", temp_hist, "Bzero", "MIX", Nevt_fluc_pi0, i, Scale_MIX_test, "otherwise");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_UUBAR, "root", temp_hist, "Continuum", "UUBAR", Nevt_fluc_pi0, i, Scale_UUBAR_test, "otherwise");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_DDBAR, "root", temp_hist, "Continuum", "DDBAR", Nevt_fluc_pi0, i, Scale_DDBAR_test, "otherwise");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_SSBAR, "root", temp_hist, "Continuum", "SSBAR", Nevt_fluc_pi0, i, Scale_SSBAR_test, "otherwise");
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_CHARM, "root", temp_hist, "Continuum", "CHARM", Nevt_fluc_pi0, i, Scale_CHARM_test, "otherwise");
        temp_hist->Reset();
    }
    /* ====================================== */
