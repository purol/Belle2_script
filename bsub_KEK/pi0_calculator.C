...
int main(int argc, char* argv[])
{
    ...
    for (int i = 0; i < NToys; i++) {
        ...
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B2Xsnunu", temp_hist, "Bplus", "SIGNAL", Nevt_fluc_pi0, i, Scale_Xsu_nonresonant_test, "B2Xsnunu");
        temp_hist->Reset();
        ...
        temp_hist->Reset();
        GetFlucNevt(MC_dirname_SIGNAL, "B02Xsnunu", temp_hist, "Bzero", "SIGNAL", Nevt_fluc_pi0, i, Scale_Xsd_nonresonant_test, "B02Xsnunu");
        temp_hist->Reset();
