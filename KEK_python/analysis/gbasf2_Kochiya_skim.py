...
U_preselection_vars = ["extraInfo(decayModeID)", "nROE_Tracks(looseMask)", "daughter(0, chiProb)"]
if(args.inputsample=="MC_SIGNAL") or (args.inputsample=="MC_Jpsi_SIGNAL"):
...
ma.applyCuts("Upsilon(4S):withoutneutrino", "[nROE_Tracks(looseMask) < 0.5] and [daughter(0, chiProb) > -0.5]", path=my_path)
