...
parser.add_argument('--inputsample', required=True, type=str, help='sample type. list) default, MC_SIGNAL, MC_BKG_BB, MC_Jpsi, MC_Jpsi_SIGNAL, MC_BKG_BB_for_Jpsi')
args = parser.parse_args()
if(args.inputsample!="default" and args.inputsample!="MC_BKG_BB" and args.inputsample!="MC_Jpsi" and args.inputsample!="MC_BKG_BB_for_Jpsi" and args.inputsample!="MC_SIGNAL" and args.inputsample!="MC_Jpsi_SIGNAL"):
    exit(1)
...
leptonInfo = ["nParticlesInList(e+:ElectronFBDT)", "nParticlesInList(mu+:MuonFBDT)"]
