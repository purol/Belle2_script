...
void TMVAClassTrainBBBKG( TString myMethodList = "" )
{
   ...
   dataloader->AddSpectator("cleoConThrust0", 'F');
   dataloader->AddSpectator("cleoConThrust1", 'F');
   dataloader->AddSpectator("cleoConThrust2", 'F');
   dataloader->AddSpectator("cleoConThrust3", 'F');
   dataloader->AddSpectator("cleoConThrust4", 'F');
   dataloader->AddSpectator("cleoConThrust5", 'F');
   dataloader->AddSpectator("cleoConThrust6", 'F');
   dataloader->AddSpectator("cleoConThrust7", 'F');
   dataloader->AddSpectator("cleoConThrust8", 'F');
