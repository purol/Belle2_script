...
void Deconvertor(const char* dirname, double OBB, double OContinuum){
        ...
        for (unsigned int i = 0; i < names.size(); i++) {
            ...
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_nKexcep", &temp_BsigDataToTree[14]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_nPiexcep", &temp_BsigDataToTree[15]);
            temp_tree->SetBranchAddress("Bsig_R2", &temp_BsigDataToTree[16]);
            temp_tree->SetBranchAddress("Bsig_thrustBm", &temp_BsigDataToTree[17]);
            temp_tree->SetBranchAddress("Bsig_thrustOm", &temp_BsigDataToTree[18]);
            temp_tree->SetBranchAddress("Bsig_cosTBTO", &temp_BsigDataToTree[19]);
            temp_tree->SetBranchAddress("Bsig_cosTBz", &temp_BsigDataToTree[20]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_et", &temp_BsigDataToTree[21]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_mm2", &temp_BsigDataToTree[22]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso00", &temp_BsigDataToTree[23]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso01", &temp_BsigDataToTree[24]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso02", &temp_BsigDataToTree[25]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso03", &temp_BsigDataToTree[26]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso04", &temp_BsigDataToTree[27]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso10", &temp_BsigDataToTree[28]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso12", &temp_BsigDataToTree[29]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso14", &temp_BsigDataToTree[30]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso20", &temp_BsigDataToTree[31]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso22", &temp_BsigDataToTree[32]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hso24", &temp_BsigDataToTree[33]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hoo0", &temp_BsigDataToTree[34]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hoo1", &temp_BsigDataToTree[35]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hoo2", &temp_BsigDataToTree[36]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hoo3", &temp_BsigDataToTree[37]);
            temp_tree->SetBranchAddress("Bsig_KSFWVariables_hoo4", &temp_BsigDataToTree[38]);
            temp_tree->SetBranchAddress("Bsig_CleoConeCS_1", &temp_BsigDataToTree[39]);
            temp_tree->SetBranchAddress("Bsig_CleoConeCS_2", &temp_BsigDataToTree[40]);
            temp_tree->SetBranchAddress("Bsig_CleoConeCS_3", &temp_BsigDataToTree[41]);
            temp_tree->SetBranchAddress("Bsig_CleoConeCS_4", &temp_BsigDataToTree[42]);
            temp_tree->SetBranchAddress("Bsig_CleoConeCS_5", &temp_BsigDataToTree[43]);
            temp_tree->SetBranchAddress("Bsig_CleoConeCS_6", &temp_BsigDataToTree[44]);
            temp_tree->SetBranchAddress("Bsig_CleoConeCS_7", &temp_BsigDataToTree[45]);
            temp_tree->SetBranchAddress("Bsig_CleoConeCS_8", &temp_BsigDataToTree[46]);
            temp_tree->SetBranchAddress("Bsig_CleoConeCS_9", &temp_BsigDataToTree[47]);
            temp_tree->SetBranchAddress("Bsig_pt", &temp_BsigDataToTree[48]);
            temp_tree->SetBranchAddress("Bsig_useCMSFrame_pt", &temp_BsigDataToTree[49]);
            temp_tree->SetBranchAddress("Bsig_theta", &temp_BsigDataToTree[50]);
            temp_tree->SetBranchAddress("Bsig_useCMSFrame_theta", &temp_BsigDataToTree[51]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_nDc", &temp_BsigDataToTree[52]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dc_pValue_med", &temp_BsigDataToTree[53]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dc_pValue_std", &temp_BsigDataToTree[54]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dcsimpleveto_chiProb", &temp_BsigDataToTree[55]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dcsimpleveto_dr", &temp_BsigDataToTree[56]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dcsimpleveto_dz", &temp_BsigDataToTree[57]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dcsimpleveto_M", &temp_BsigDataToTree[58]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_nD0", &temp_BsigDataToTree[59]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0_pValue_med", &temp_BsigDataToTree[60]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0_pValue_std", &temp_BsigDataToTree[61]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0simpleveto_chiProb", &temp_BsigDataToTree[62]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0simpleveto_dr", &temp_BsigDataToTree[63]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0simpleveto_dz", &temp_BsigDataToTree[64]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0simpleveto_M", &temp_BsigDataToTree[65]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_mychiProb", &temp_BsigDataToTree[66]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_mydr", &temp_BsigDataToTree[67]);
            temp_tree->SetBranchAddress("Bsig_daughter_0_extraInfo_mydz", &temp_BsigDataToTree[68]);
            for (int i_PID = 0; i_PID < N_PID_syst; i_PID++) {
                temp_tree->SetBranchAddress(("Bsig_daughter_0_extraInfo_nKtruebin" + std::to_string(i_PID)).c_str(), &temp_BsigDataToTree[69 + 4 * i_PID]);
                temp_tree->SetBranchAddress(("Bsig_daughter_0_extraInfo_nKmisbin" + std::to_string(i_PID)).c_str(), &temp_BsigDataToTree[69 + 4 * i_PID + 1]);
                temp_tree->SetBranchAddress(("Bsig_daughter_0_extraInfo_npitruebin" + std::to_string(i_PID)).c_str(), &temp_BsigDataToTree[69 + 4 * i_PID + 2]);
                temp_tree->SetBranchAddress(("Bsig_daughter_0_extraInfo_npimisbin" + std::to_string(i_PID)).c_str(), &temp_BsigDataToTree[69 + 4 * i_PID + 3]);
            }
