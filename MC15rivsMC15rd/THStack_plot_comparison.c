...
void THStack_plot_sideband() {
    ...
    for (int k = 0; k < (int)variable_names.size(); k++) { // draw
        ...
        MC15rd_hist[k]->SetFillColor(4); MC15rd_hist[k]->SetLineWidth(0); MC15rd_hist[k]->SetFillStyle(3004); MC15rd_hist[k]->Draw("e2 Hist");
        MC15ri_hist[k]->SetFillColor(2); MC15ri_hist[k]->SetLineWidth(0); MC15ri_hist[k]->SetFillStyle(3005); MC15ri_hist[k]->Draw("e2 Hist SAME");
