...
int main(int argc, char** argv) {
    ...
    const float* f_train;
    safe_xgboost(XGBoosterPredict(h_booster, h_train2, 0, Niter, false, &out_len_train, &f_train));
    ...
    const float* f_test;
    safe_xgboost(XGBoosterPredict(h_booster, h_test, 0, Niter, false, &out_len_test, &f_test));
