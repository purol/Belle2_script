...
int main(int argc, char* argv[]) { 
    /*
    * argv[1]: output dirname (ex. /home/belle2/junewoo/storage_b1/bsub/Analysis/Satori_LS_MC_side/CHG_analysis/test_v000)
    * argv[2]: weightfile version name (ex. Aqua, Kokoro, Satori, ...)
    * argv[3]: simple dirname (ex. v000, v001, ...)
    * argv[4]: input dirname
    */

    std::string file_path = std::string(argv[4]) + "/final_output_data";
