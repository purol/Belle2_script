...
# Beam energy correction is only applied to data proc12 chunk2 off-resonance
...
# photon energy bias correction only applies to data (proc12)
...
if(args.inputsample=="MC_SIGNAL") or (args.inputsample=="MC_Jpsi_SIGNAL") or (args.inputsample=="run_dependent"):
