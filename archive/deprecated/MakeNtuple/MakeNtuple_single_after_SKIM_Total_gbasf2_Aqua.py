...
basf2.conditions.prepend_globaltag("analysis_tools_light-2106-rhea")
...
ma.fillParticleListFromMC('K+:MC', cut = 'mcPrimary', addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)
ma.fillParticleListFromMC('K*+:MC', cut = 'mcPrimary', addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)
ma.fillParticleListFromMC('nu_e:MC', cut = 'mcPrimary', addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)
ma.fillParticleListFromMC('nu_mu:MC', cut = 'mcPrimary', addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)
ma.fillParticleListFromMC('nu_tau:MC', cut = 'mcPrimary', addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)
ma.fillParticleListFromMC('Xsu:MC', cut = 'mcPrimary', addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)
ma.fillParticleListFromMC('Xsd:MC', cut = 'mcPrimary', addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)
ma.fillParticleListFromMC("K0:MC", cut = "mcPrimary", addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)
ma.fillParticleListFromMC("K*0:MC", cut = "mcPrimary", addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)
ma.fillParticleListFromMC("Upsilon(4S):MC", cut = "mcPrimary", addDaughters=True, skipNonPrimaryDaughters=True, path=my_path)

ma.reconstructMCDecay('B+:Kcharge_e =direct=> K+:MC nu_e:MC anti-nu_e:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B+:Kcharge_mu =direct=> K+:MC nu_mu:MC anti-nu_mu:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B+:Kcharge_tau =direct=> K+:MC nu_tau:MC anti-nu_tau:MC ?gamma', cut='', path=my_path)
ma.copyLists(outputListName="B+:Kcharge_total", inputListNames=["B+:Kcharge_e", "B+:Kcharge_mu", "B+:Kcharge_tau"], path=my_path)

ma.reconstructMCDecay('B+:Kstarcharge_e =direct=> K*+:MC nu_e:MC anti-nu_e:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B+:Kstarcharge_mu =direct=> K*+:MC nu_mu:MC anti-nu_mu:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B+:Kstarcharge_tau =direct=> K*+:MC nu_tau:MC anti-nu_tau:MC ?gamma', cut='', path=my_path)
...
ma.reconstructMCDecay('B+:Xsu_e =direct=> Xsu:MC nu_e:MC anti-nu_e:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B+:Xsu_mu =direct=> Xsu:MC nu_mu:MC anti-nu_mu:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B+:Xsu_tau =direct=> Xsu:MC nu_tau:MC anti-nu_tau:MC ?gamma', cut='', path=my_path)
...
ma.reconstructMCDecay('B0:Kneutral_e =direct=> K0:MC nu_e:MC anti-nu_e:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B0:Kneutral_mu =direct=> K0:MC nu_mu:MC anti-nu_mu:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B0:Kneutral_tau =direct=> K0:MC nu_tau:MC anti-nu_tau:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B0:Kneutral_e_oppose =direct=> anti-K0:MC nu_e:MC anti-nu_e:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B0:Kneutral_mu_oppose =direct=> anti-K0:MC nu_mu:MC anti-nu_mu:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B0:Kneutral_tau_oppose =direct=> anti-K0:MC nu_tau:MC anti-nu_tau:MC ?gamma', cut='', path=my_path)
...
ma.reconstructMCDecay('B0:Kstarneutral_e =direct=> K*0:MC nu_e:MC anti-nu_e:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B0:Kstarneutral_mu =direct=> K*0:MC nu_mu:MC anti-nu_mu:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B0:Kstarneutral_tau =direct=> K*0:MC nu_tau:MC anti-nu_tau:MC ?gamma', cut='', path=my_path)
...
ma.reconstructMCDecay('B0:Xsd_e =direct=> Xsd:MC nu_e:MC anti-nu_e:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B0:Xsd_mu =direct=> Xsd:MC nu_mu:MC anti-nu_mu:MC ?gamma', cut='', path=my_path)
ma.reconstructMCDecay('B0:Xsd_tau =direct=> Xsd:MC nu_tau:MC anti-nu_tau:MC ?gamma', cut='', path=my_path)
