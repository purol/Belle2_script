...
void ApplicationEachFile(const char* filename, const char* dataset_path)
{
   ...
   theTree->SetBranchAddress("extraInfo__boNgammav200_900__bc", &temp_UpsilonDataToTree[72]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_900_matched__bc", &temp_UpsilonDataToTree[73]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_900_unmatched__bc", &temp_UpsilonDataToTree[74]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_900__bc", &temp_UpsilonDataToTree[75]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_900_matched__bc", &temp_UpsilonDataToTree[76]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_900_unmatched__bc", &temp_UpsilonDataToTree[77]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_925__bc", &temp_UpsilonDataToTree[78]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_925_matched__bc", &temp_UpsilonDataToTree[79]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_925_unmatched__bc", &temp_UpsilonDataToTree[80]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_925__bc", &temp_UpsilonDataToTree[81]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_925_matched__bc", &temp_UpsilonDataToTree[82]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_925_unmatched__bc", &temp_UpsilonDataToTree[83]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_950__bc", &temp_UpsilonDataToTree[84]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_950_matched__bc", &temp_UpsilonDataToTree[85]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_950_unmatched__bc", &temp_UpsilonDataToTree[86]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_950__bc", &temp_UpsilonDataToTree[87]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_950_matched__bc", &temp_UpsilonDataToTree[88]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_950_unmatched__bc", &temp_UpsilonDataToTree[89]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_975__bc", &temp_UpsilonDataToTree[90]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_975_matched__bc", &temp_UpsilonDataToTree[91]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_975_unmatched__bc", &temp_UpsilonDataToTree[92]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_975__bc", &temp_UpsilonDataToTree[93]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_975_matched__bc", &temp_UpsilonDataToTree[94]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_975_unmatched__bc", &temp_UpsilonDataToTree[95]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_025__bc", &temp_UpsilonDataToTree[96]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_025_matched__bc", &temp_UpsilonDataToTree[97]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_025_unmatched__bc", &temp_UpsilonDataToTree[98]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_025__bc", &temp_UpsilonDataToTree[99]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_025_matched__bc", &temp_UpsilonDataToTree[100]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_025_unmatched__bc", &temp_UpsilonDataToTree[101]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_050__bc", &temp_UpsilonDataToTree[102]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_050_matched__bc", &temp_UpsilonDataToTree[103]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_050_unmatched__bc", &temp_UpsilonDataToTree[104]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_050__bc", &temp_UpsilonDataToTree[105]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_050_matched__bc", &temp_UpsilonDataToTree[106]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_050_unmatched__bc", &temp_UpsilonDataToTree[107]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_075__bc", &temp_UpsilonDataToTree[108]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_075_matched__bc", &temp_UpsilonDataToTree[109]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_075_unmatched__bc", &temp_UpsilonDataToTree[110]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_075__bc", &temp_UpsilonDataToTree[111]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_075_matched__bc", &temp_UpsilonDataToTree[112]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_075_unmatched__bc", &temp_UpsilonDataToTree[113]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_100__bc", &temp_UpsilonDataToTree[114]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_100_matched__bc", &temp_UpsilonDataToTree[115]);
   theTree->SetBranchAddress("extraInfo__boNgammav200_100_unmatched__bc", &temp_UpsilonDataToTree[116]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_100__bc", &temp_UpsilonDataToTree[117]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_100_matched__bc", &temp_UpsilonDataToTree[118]);
   theTree->SetBranchAddress("extraInfo__boEeclv200_100_unmatched__bc", &temp_UpsilonDataToTree[119]);
   theTree->SetBranchAddress("nParticlesInList__boD__pl__clDecayIntoKL0__bc", &temp_UpsilonDataToTree[120]);
   theTree->SetBranchAddress("nParticlesInList__boD0__clDecayIntoKL0__bc", &temp_UpsilonDataToTree[121]);
   theTree->SetBranchAddress("nParticlesInList__boB__pl__clKnn__bc", &temp_UpsilonDataToTree[122]);
   theTree->SetBranchAddress("invMassInLists__bon0__clKnn__bc", &temp_UpsilonDataToTree[123]);
   theTree->SetBranchAddress("nParticlesInList__boB__pl__clKstarnn__bc", &temp_UpsilonDataToTree[124]);
   theTree->SetBranchAddress("invMassInLists__bon0__clKstarnn__bc", &temp_UpsilonDataToTree[125]);
   theTree->SetBranchAddress("nParticlesInList__boB0__clK0nn__bc", &temp_UpsilonDataToTree[126]);
   theTree->SetBranchAddress("invMassInLists__bon0__clK0nn__bc", &temp_UpsilonDataToTree[127]);
   theTree->SetBranchAddress("nParticlesInList__boB0__clKstar0nn__bc", &temp_UpsilonDataToTree[128]);
   theTree->SetBranchAddress("invMassInLists__bon0__clKstar0nn__bc", &temp_UpsilonDataToTree[129]);
