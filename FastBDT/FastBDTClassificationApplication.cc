...
void ApplicationEachFile(const char* filename, const char* dataset_path)
{
   ...
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_nKexcep", &temp_BsigDataToTree[14]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_nPiexcep", &temp_BsigDataToTree[15]);
   theTree->SetBranchAddress("Bsig_R2", &temp_BsigDataToTree[16]);
   theTree->SetBranchAddress("Bsig_thrustBm", &temp_BsigDataToTree[17]);
   theTree->SetBranchAddress("Bsig_thrustOm", &temp_BsigDataToTree[18]);
   theTree->SetBranchAddress("Bsig_cosTBTO", &temp_BsigDataToTree[19]);
   theTree->SetBranchAddress("Bsig_cosTBz", &temp_BsigDataToTree[20]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_et", &temp_BsigDataToTree[21]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_mm2", &temp_BsigDataToTree[22]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso00", &temp_BsigDataToTree[23]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso01", &temp_BsigDataToTree[24]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso02", &temp_BsigDataToTree[25]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso03", &temp_BsigDataToTree[26]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso04", &temp_BsigDataToTree[27]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso10", &temp_BsigDataToTree[28]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso12", &temp_BsigDataToTree[29]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso14", &temp_BsigDataToTree[30]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso20", &temp_BsigDataToTree[31]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso22", &temp_BsigDataToTree[32]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hso24", &temp_BsigDataToTree[33]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hoo0", &temp_BsigDataToTree[34]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hoo1", &temp_BsigDataToTree[35]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hoo2", &temp_BsigDataToTree[36]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hoo3", &temp_BsigDataToTree[37]);
   theTree->SetBranchAddress("Bsig_KSFWVariables_hoo4", &temp_BsigDataToTree[38]);
   theTree->SetBranchAddress("Bsig_CleoConeCS_1", &temp_BsigDataToTree[39]);
   theTree->SetBranchAddress("Bsig_CleoConeCS_2", &temp_BsigDataToTree[40]);
   theTree->SetBranchAddress("Bsig_CleoConeCS_3", &temp_BsigDataToTree[41]);
   theTree->SetBranchAddress("Bsig_CleoConeCS_4", &temp_BsigDataToTree[42]);
   theTree->SetBranchAddress("Bsig_CleoConeCS_5", &temp_BsigDataToTree[43]);
   theTree->SetBranchAddress("Bsig_CleoConeCS_6", &temp_BsigDataToTree[44]);
   theTree->SetBranchAddress("Bsig_CleoConeCS_7", &temp_BsigDataToTree[45]);
   theTree->SetBranchAddress("Bsig_CleoConeCS_8", &temp_BsigDataToTree[46]);
   theTree->SetBranchAddress("Bsig_CleoConeCS_9", &temp_BsigDataToTree[47]);
   theTree->SetBranchAddress("Bsig_pt", &temp_BsigDataToTree[48]);
   theTree->SetBranchAddress("Bsig_useCMSFrame_pt", &temp_BsigDataToTree[49]);
   theTree->SetBranchAddress("Bsig_theta", &temp_BsigDataToTree[50]);
   theTree->SetBranchAddress("Bsig_useCMSFrame_theta", &temp_BsigDataToTree[51]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_nDc", &temp_BsigDataToTree[52]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dc_pValue_med", &temp_BsigDataToTree[53]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dc_pValue_std", &temp_BsigDataToTree[54]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dcsimpleveto_chiProb", &temp_BsigDataToTree[55]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dcsimpleveto_dr", &temp_BsigDataToTree[56]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dcsimpleveto_dz", &temp_BsigDataToTree[57]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_Dcsimpleveto_M", &temp_BsigDataToTree[58]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_nD0", &temp_BsigDataToTree[59]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0_pValue_med", &temp_BsigDataToTree[60]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0_pValue_std", &temp_BsigDataToTree[61]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0simpleveto_chiProb", &temp_BsigDataToTree[62]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0simpleveto_dr", &temp_BsigDataToTree[63]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0simpleveto_dz", &temp_BsigDataToTree[64]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_D0simpleveto_M", &temp_BsigDataToTree[65]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_mychiProb", &temp_BsigDataToTree[66]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_mydr", &temp_BsigDataToTree[67]);
   theTree->SetBranchAddress("Bsig_daughter_0_extraInfo_mydz", &temp_BsigDataToTree[68]);
   for (int i_PID = 0; i_PID < N_PID_syst; i_PID++) {
       theTree->SetBranchAddress(("Bsig_daughter_0_extraInfo_nKtruebin" + std::to_string(i_PID)).c_str(), &temp_BsigDataToTree[69 + 4 * i_PID]);
       theTree->SetBranchAddress(("Bsig_daughter_0_extraInfo_nKmisbin" + std::to_string(i_PID)).c_str(), &temp_BsigDataToTree[69 + 4 * i_PID + 1]);
       theTree->SetBranchAddress(("Bsig_daughter_0_extraInfo_npitruebin" + std::to_string(i_PID)).c_str(), &temp_BsigDataToTree[69 + 4 * i_PID + 2]);
       theTree->SetBranchAddress(("Bsig_daughter_0_extraInfo_npimisbin" + std::to_string(i_PID)).c_str(), &temp_BsigDataToTree[69 + 4 * i_PID + 3]);
   }
