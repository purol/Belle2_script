...
void main()
{
    ...
    const char* CHG_input = "/media/sf_virtualbox_folder/20211109/For_TMVA_BKG/train/Mxs_large/final_output_merge_Mxs_larger_CHG_train_data.root";
    const char* MIX_input = "/media/sf_virtualbox_folder/20211109/For_TMVA_BKG/train/Mxs_large/final_output_merge_Mxs_larger_MIX_train_data.root";
    ...
    const char* CHG_input_test = "/media/sf_virtualbox_folder/20211109/For_TMVA_BKG/test/Mxs_large/final_output_merge_Mxs_larger_CHG_test_data.root";
    const char* MIX_input_test = "/media/sf_virtualbox_folder/20211109/For_TMVA_BKG/test/Mxs_large/final_output_merge_Mxs_larger_MIX_test_data.root";

    FillVariables(SIGNAL_input, input_vars, &IsSignal, &weight);
    FillVariables(CHG_input, input_vars, &IsSignal, &weight);
    FillVariables(MIX_input, input_vars, &IsSignal, &weight);
    ...
    FillVariables(CHG_input_test, input_vars2, &IsSignal2, &weight2);
    FillVariables(MIX_input_test, input_vars2, &IsSignal2, &weight2);
